...
typedef struct _THdfsFileDesc__isset {
  _THdfsFileDesc__isset() : file_metadata(false) {}
  bool file_metadata :1;
} _THdfsFileDesc__isset;
...
class THdfsFileDesc {
 public:
  ...
  THdfsFileDesc() : file_desc_data(), file_metadata() {
  }
