...
void TExprNode::__set_is_codegen_disabled(const bool val) {
  this->is_codegen_disabled = val;
__isset.is_codegen_disabled = true;
}
...
void swap(TExprNode &a, TExprNode &b) {
  ...
  swap(a.is_codegen_disabled, b.is_codegen_disabled);
...
TExprNode::TExprNode(const TExprNode& other83) {
  ...
  is_codegen_disabled = other83.is_codegen_disabled;
...
TExprNode::TExprNode( TExprNode&& other84) {
  ...
  is_codegen_disabled = std::move(other84.is_codegen_disabled);
...
TExprNode& TExprNode::operator=(const TExprNode& other85) {
  ...
  is_codegen_disabled = other85.is_codegen_disabled;
...
TExprNode& TExprNode::operator=(TExprNode&& other86) {
  ...
  is_codegen_disabled = std::move(other86.is_codegen_disabled);
...
void TExprNode::printTo(std::ostream& out) const {
  ...
  out << ", " << "is_codegen_disabled="; (__isset.is_codegen_disabled ? (out << to_string(is_codegen_disabled)) : (out << "<null>"));
  out << ")";
}
