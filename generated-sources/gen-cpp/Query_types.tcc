    ...
    switch (fid)
    {
      ...
      case 104:
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            this->enabled_runtime_filter_types.clear();
            uint32_t _size11;
            ...
            {
               ::impala::TRuntimeFilterType::type _elem16;
              int32_t ecast17;
              xfer += iprot->readI32(ecast17);
              _elem16 = ( ::impala::TRuntimeFilterType::type)ecast17;
              this->enabled_runtime_filter_types.insert(_elem16);
            }
      ...
      case 124:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->minmax_filtering_level = ( ::impala::TMinmaxFilteringLevel::type)ecast18;
      ...
      case 128:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->kudu_replica_selection = (TKuduReplicaSelection::type)ecast19;
      ...
      case 132:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->minmax_filter_fast_code_path = (TMinmaxFilterFastCodePathMode::type)ecast20;
      ...
      case 135:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->parquet_bloom_filter_write = (TParquetBloomFilterWrite::type)ecast21;
      ...
      case 140:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->parquet_dictionary_runtime_filter_entry_limit);
          this->__isset.parquet_dictionary_runtime_filter_entry_limit = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 141:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->abort_java_udf_on_exception);
          this->__isset.abort_java_udf_on_exception = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 142:
        if (ftype == ::apache::thrift::protocol::T_BOOL) {
          xfer += iprot->readBool(this->orc_async_read);
          this->__isset.orc_async_read = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
      case 143:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->runtime_in_list_filter_entry_limit);
          this->__isset.runtime_in_list_filter_entry_limit = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t TQueryOptions::write(Protocol_* oprot) const {
  ...
  if (this->__isset.enabled_runtime_filter_types) {
    xfer += oprot->writeFieldBegin("enabled_runtime_filter_types", ::apache::thrift::protocol::T_SET, 104);
    {
      xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_I32, static_cast<uint32_t>(this->enabled_runtime_filter_types.size()));
      std::set< ::impala::TRuntimeFilterType::type> ::const_iterator _iter22;
      for (_iter22 = this->enabled_runtime_filter_types.begin(); _iter22 != this->enabled_runtime_filter_types.end(); ++_iter22)
      {
  ...
  if (this->__isset.parquet_dictionary_runtime_filter_entry_limit) {
    xfer += oprot->writeFieldBegin("parquet_dictionary_runtime_filter_entry_limit", ::apache::thrift::protocol::T_I32, 140);
    xfer += oprot->writeI32(this->parquet_dictionary_runtime_filter_entry_limit);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.abort_java_udf_on_exception) {
    xfer += oprot->writeFieldBegin("abort_java_udf_on_exception", ::apache::thrift::protocol::T_BOOL, 141);
    xfer += oprot->writeBool(this->abort_java_udf_on_exception);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.orc_async_read) {
    xfer += oprot->writeFieldBegin("orc_async_read", ::apache::thrift::protocol::T_BOOL, 142);
    xfer += oprot->writeBool(this->orc_async_read);
    xfer += oprot->writeFieldEnd();
  }
  if (this->__isset.runtime_in_list_filter_entry_limit) {
    xfer += oprot->writeFieldBegin("runtime_in_list_filter_entry_limit", ::apache::thrift::protocol::T_I32, 143);
    xfer += oprot->writeI32(this->runtime_in_list_filter_entry_limit);
    xfer += oprot->writeFieldEnd();
  }
    ...
    switch (fid)
    {
      ...
      case 5:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->session_type = (TSessionType::type)ecast31;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->tables_missing_stats.resize(_size36);
            uint32_t _i40;
            for (_i40 = 0; _i40 < _size36; ++_i40)
            {
              xfer += this->tables_missing_stats[_i40].read(iprot);
            }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->tables_with_corrupt_stats.resize(_size41);
            uint32_t _i45;
            for (_i45 = 0; _i45 < _size41; ++_i45)
            {
              xfer += this->tables_with_corrupt_stats[_i45].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->tables_missing_diskids.resize(_size46);
            uint32_t _i50;
            for (_i50 = 0; _i50 < _size46; ++_i50)
            {
              xfer += this->tables_missing_diskids[_i50].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t TQueryCtx::write(Protocol_* oprot) const {
  ...
  if (this->__isset.tables_missing_stats) {
    xfer += oprot->writeFieldBegin("tables_missing_stats", ::apache::thrift::protocol::T_LIST, 8);
    {
      ...
      std::vector< ::impala::TTableName> ::const_iterator _iter51;
      for (_iter51 = this->tables_missing_stats.begin(); _iter51 != this->tables_missing_stats.end(); ++_iter51)
      {
  ...
  if (this->__isset.tables_with_corrupt_stats) {
    xfer += oprot->writeFieldBegin("tables_with_corrupt_stats", ::apache::thrift::protocol::T_LIST, 11);
    {
      ...
      std::vector< ::impala::TTableName> ::const_iterator _iter52;
      for (_iter52 = this->tables_with_corrupt_stats.begin(); _iter52 != this->tables_with_corrupt_stats.end(); ++_iter52)
      {
  ...
  if (this->__isset.tables_missing_diskids) {
    xfer += oprot->writeFieldBegin("tables_missing_diskids", ::apache::thrift::protocol::T_LIST, 16);
    {
      ...
      std::vector< ::impala::TTableName> ::const_iterator _iter53;
      for (_iter53 = this->tables_missing_diskids.begin(); _iter53 != this->tables_missing_diskids.end(); ++_iter53)
      {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->fragments.resize(_size58);
            uint32_t _i62;
            for (_i62 = 0; _i62 < _size58; ++_i62)
            {
              xfer += this->fragments[_i62].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            {
               ::impala::TPlanNodeId _key68;
              xfer += iprot->readI32(_key68);
               ::impala::TScanRangeSpec& _val69 = this->per_node_scan_ranges[_key68];
...
uint32_t TPlanExecInfo::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("fragments", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector< ::impala::TPlanFragment> ::const_iterator _iter70;
    for (_iter70 = this->fragments.begin(); _iter70 != this->fragments.end(); ++_iter70)
    {
  ...
  if (this->__isset.per_node_scan_ranges) {
    xfer += oprot->writeFieldBegin("per_node_scan_ranges", ::apache::thrift::protocol::T_MAP, 2);
    {
      ...
      std::map< ::impala::TPlanNodeId,  ::impala::TScanRangeSpec> ::const_iterator _iter71;
      for (_iter71 = this->per_node_scan_ranges.begin(); _iter71 != this->per_node_scan_ranges.end(); ++_iter71)
      {
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->plan_exec_info.resize(_size80);
            uint32_t _i84;
            for (_i84 = 0; _i84 < _size80; ++_i84)
            {
              xfer += this->plan_exec_info[_i84].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->stmt_type = ( ::impala::TStmtType::type)ecast85;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->host_list.resize(_size86);
            uint32_t _i90;
            for (_i90 = 0; _i90 < _size86; ++_i90)
            {
              xfer += this->host_list[_i90].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t TQueryExecRequest::write(Protocol_* oprot) const {
  ...
  if (this->__isset.plan_exec_info) {
    xfer += oprot->writeFieldBegin("plan_exec_info", ::apache::thrift::protocol::T_LIST, 1);
    {
      ...
      std::vector<TPlanExecInfo> ::const_iterator _iter91;
      for (_iter91 = this->plan_exec_info.begin(); _iter91 != this->plan_exec_info.end(); ++_iter91)
      {
  ...
  xfer += oprot->writeFieldBegin("host_list", ::apache::thrift::protocol::T_LIST, 7);
  {
    ...
    std::vector< ::impala::TNetworkAddress> ::const_iterator _iter92;
    for (_iter92 = this->host_list.begin(); _iter92 != this->host_list.end(); ++_iter92)
    {
