...
const std::map<int, const char*> _TRuntimeFilterType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(3, _kTRuntimeFilterTypeValues, _kTRuntimeFilterTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
...
void TScanRange::__set_file_metadata(const std::string& val) {
