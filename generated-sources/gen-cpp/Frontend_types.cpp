...
TExecutorGroupSet::~TExecutorGroupSet() throw() {
}


void TExecutorGroupSet::__set_curr_num_executors(const int32_t val) {
  this->curr_num_executors = val;
}

void TExecutorGroupSet::__set_expected_num_executors(const int32_t val) {
  this->expected_num_executors = val;
}

void TExecutorGroupSet::__set_exec_group_name_prefix(const std::string& val) {
  this->exec_group_name_prefix = val;
}
std::ostream& operator<<(std::ostream& out, const TExecutorGroupSet& obj)
{
  obj.printTo(out);
  return out;
}
...
void swap(TExecutorGroupSet &a, TExecutorGroupSet &b) {
  using ::std::swap;
  swap(a.curr_num_executors, b.curr_num_executors);
  swap(a.expected_num_executors, b.expected_num_executors);
  swap(a.exec_group_name_prefix, b.exec_group_name_prefix);
  swap(a.__isset, b.__isset);
}

TExecutorGroupSet::TExecutorGroupSet(const TExecutorGroupSet& other328) {
  curr_num_executors = other328.curr_num_executors;
  expected_num_executors = other328.expected_num_executors;
  exec_group_name_prefix = other328.exec_group_name_prefix;
  __isset = other328.__isset;
}
TExecutorGroupSet::TExecutorGroupSet( TExecutorGroupSet&& other329) {
  curr_num_executors = std::move(other329.curr_num_executors);
  expected_num_executors = std::move(other329.expected_num_executors);
  exec_group_name_prefix = std::move(other329.exec_group_name_prefix);
  __isset = std::move(other329.__isset);
}
TExecutorGroupSet& TExecutorGroupSet::operator=(const TExecutorGroupSet& other330) {
  curr_num_executors = other330.curr_num_executors;
  expected_num_executors = other330.expected_num_executors;
  exec_group_name_prefix = other330.exec_group_name_prefix;
  __isset = other330.__isset;
  return *this;
}
TExecutorGroupSet& TExecutorGroupSet::operator=(TExecutorGroupSet&& other331) {
  curr_num_executors = std::move(other331.curr_num_executors);
  expected_num_executors = std::move(other331.expected_num_executors);
  exec_group_name_prefix = std::move(other331.exec_group_name_prefix);
  __isset = std::move(other331.__isset);
  return *this;
}
void TExecutorGroupSet::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TExecutorGroupSet(";
  out << "curr_num_executors=" << to_string(curr_num_executors);
  out << ", " << "expected_num_executors=" << to_string(expected_num_executors);
  out << ", " << "exec_group_name_prefix=" << to_string(exec_group_name_prefix);
  out << ")";
}
...
void TUpdateExecutorMembershipRequest::__set_exec_group_sets(const std::vector<TExecutorGroupSet> & val) {
  this->exec_group_sets = val;
}
...
void swap(TUpdateExecutorMembershipRequest &a, TUpdateExecutorMembershipRequest &b) {
  ...
  swap(a.exec_group_sets, b.exec_group_sets);
  swap(a.__isset, b.__isset);
}

TUpdateExecutorMembershipRequest::TUpdateExecutorMembershipRequest(const TUpdateExecutorMembershipRequest& other352) {
  hostnames = other352.hostnames;
  ip_addresses = other352.ip_addresses;
  exec_group_sets = other352.exec_group_sets;
  __isset = other352.__isset;
}
TUpdateExecutorMembershipRequest::TUpdateExecutorMembershipRequest( TUpdateExecutorMembershipRequest&& other353) {
  hostnames = std::move(other353.hostnames);
  ip_addresses = std::move(other353.ip_addresses);
  exec_group_sets = std::move(other353.exec_group_sets);
  __isset = std::move(other353.__isset);
}
TUpdateExecutorMembershipRequest& TUpdateExecutorMembershipRequest::operator=(const TUpdateExecutorMembershipRequest& other354) {
  hostnames = other354.hostnames;
  ip_addresses = other354.ip_addresses;
  exec_group_sets = other354.exec_group_sets;
  __isset = other354.__isset;
  return *this;
}
TUpdateExecutorMembershipRequest& TUpdateExecutorMembershipRequest::operator=(TUpdateExecutorMembershipRequest&& other355) {
  hostnames = std::move(other355.hostnames);
  ip_addresses = std::move(other355.ip_addresses);
  exec_group_sets = std::move(other355.exec_group_sets);
...
void TUpdateExecutorMembershipRequest::printTo(std::ostream& out) const {
  ...
  out << ", " << "exec_group_sets=" << to_string(exec_group_sets);
  out << ")";
}
...
TJvmMemoryPool::TJvmMemoryPool(const TJvmMemoryPool& other356) {
  committed = other356.committed;
  init = other356.init;
  max = other356.max;
  used = other356.used;
  peak_committed = other356.peak_committed;
  peak_init = other356.peak_init;
  peak_max = other356.peak_max;
  peak_used = other356.peak_used;
  name = other356.name;
}
TJvmMemoryPool::TJvmMemoryPool( TJvmMemoryPool&& other357) {
  committed = std::move(other357.committed);
  init = std::move(other357.init);
  max = std::move(other357.max);
  used = std::move(other357.used);
  peak_committed = std::move(other357.peak_committed);
  peak_init = std::move(other357.peak_init);
  peak_max = std::move(other357.peak_max);
  peak_used = std::move(other357.peak_used);
  name = std::move(other357.name);
}
TJvmMemoryPool& TJvmMemoryPool::operator=(const TJvmMemoryPool& other358) {
  committed = other358.committed;
  init = other358.init;
  max = other358.max;
  used = other358.used;
  peak_committed = other358.peak_committed;
  peak_init = other358.peak_init;
  peak_max = other358.peak_max;
  peak_used = other358.peak_used;
  name = other358.name;
  return *this;
}
TJvmMemoryPool& TJvmMemoryPool::operator=(TJvmMemoryPool&& other359) {
  committed = std::move(other359.committed);
  init = std::move(other359.init);
  max = std::move(other359.max);
  used = std::move(other359.used);
  peak_committed = std::move(other359.peak_committed);
  peak_init = std::move(other359.peak_init);
  peak_max = std::move(other359.peak_max);
  peak_used = std::move(other359.peak_used);
  name = std::move(other359.name);
  return *this;
}
...
TGetJvmMemoryMetricsResponse::TGetJvmMemoryMetricsResponse(const TGetJvmMemoryMetricsResponse& other366) {
  memory_pools = other366.memory_pools;
  gc_num_warn_threshold_exceeded = other366.gc_num_warn_threshold_exceeded;
  gc_num_info_threshold_exceeded = other366.gc_num_info_threshold_exceeded;
  gc_total_extra_sleep_time_millis = other366.gc_total_extra_sleep_time_millis;
  gc_count = other366.gc_count;
  gc_time_millis = other366.gc_time_millis;
}
TGetJvmMemoryMetricsResponse::TGetJvmMemoryMetricsResponse( TGetJvmMemoryMetricsResponse&& other367) {
  memory_pools = std::move(other367.memory_pools);
  gc_num_warn_threshold_exceeded = std::move(other367.gc_num_warn_threshold_exceeded);
  gc_num_info_threshold_exceeded = std::move(other367.gc_num_info_threshold_exceeded);
  gc_total_extra_sleep_time_millis = std::move(other367.gc_total_extra_sleep_time_millis);
  gc_count = std::move(other367.gc_count);
  gc_time_millis = std::move(other367.gc_time_millis);
}
TGetJvmMemoryMetricsResponse& TGetJvmMemoryMetricsResponse::operator=(const TGetJvmMemoryMetricsResponse& other368) {
  memory_pools = other368.memory_pools;
  gc_num_warn_threshold_exceeded = other368.gc_num_warn_threshold_exceeded;
  gc_num_info_threshold_exceeded = other368.gc_num_info_threshold_exceeded;
  gc_total_extra_sleep_time_millis = other368.gc_total_extra_sleep_time_millis;
  gc_count = other368.gc_count;
  gc_time_millis = other368.gc_time_millis;
  return *this;
}
TGetJvmMemoryMetricsResponse& TGetJvmMemoryMetricsResponse::operator=(TGetJvmMemoryMetricsResponse&& other369) {
  memory_pools = std::move(other369.memory_pools);
  gc_num_warn_threshold_exceeded = std::move(other369.gc_num_warn_threshold_exceeded);
  gc_num_info_threshold_exceeded = std::move(other369.gc_num_info_threshold_exceeded);
  gc_total_extra_sleep_time_millis = std::move(other369.gc_total_extra_sleep_time_millis);
  gc_count = std::move(other369.gc_count);
  gc_time_millis = std::move(other369.gc_time_millis);
  return *this;
}
...
TJvmThreadInfo::TJvmThreadInfo(const TJvmThreadInfo& other370) {
  summary = other370.summary;
  cpu_time_in_ns = other370.cpu_time_in_ns;
  user_time_in_ns = other370.user_time_in_ns;
  blocked_count = other370.blocked_count;
  blocked_time_in_ms = other370.blocked_time_in_ms;
  is_in_native = other370.is_in_native;
}
TJvmThreadInfo::TJvmThreadInfo( TJvmThreadInfo&& other371) {
  summary = std::move(other371.summary);
  cpu_time_in_ns = std::move(other371.cpu_time_in_ns);
  user_time_in_ns = std::move(other371.user_time_in_ns);
  blocked_count = std::move(other371.blocked_count);
  blocked_time_in_ms = std::move(other371.blocked_time_in_ms);
  is_in_native = std::move(other371.is_in_native);
}
TJvmThreadInfo& TJvmThreadInfo::operator=(const TJvmThreadInfo& other372) {
  summary = other372.summary;
  cpu_time_in_ns = other372.cpu_time_in_ns;
  user_time_in_ns = other372.user_time_in_ns;
  blocked_count = other372.blocked_count;
  blocked_time_in_ms = other372.blocked_time_in_ms;
  is_in_native = other372.is_in_native;
  return *this;
}
TJvmThreadInfo& TJvmThreadInfo::operator=(TJvmThreadInfo&& other373) {
  summary = std::move(other373.summary);
  cpu_time_in_ns = std::move(other373.cpu_time_in_ns);
  user_time_in_ns = std::move(other373.user_time_in_ns);
  blocked_count = std::move(other373.blocked_count);
  blocked_time_in_ms = std::move(other373.blocked_time_in_ms);
  is_in_native = std::move(other373.is_in_native);
  return *this;
}
...
TGetJvmThreadsInfoRequest::TGetJvmThreadsInfoRequest(const TGetJvmThreadsInfoRequest& other374) {
  get_complete_info = other374.get_complete_info;
}
TGetJvmThreadsInfoRequest::TGetJvmThreadsInfoRequest( TGetJvmThreadsInfoRequest&& other375) {
  get_complete_info = std::move(other375.get_complete_info);
}
TGetJvmThreadsInfoRequest& TGetJvmThreadsInfoRequest::operator=(const TGetJvmThreadsInfoRequest& other376) {
  get_complete_info = other376.get_complete_info;
  return *this;
}
TGetJvmThreadsInfoRequest& TGetJvmThreadsInfoRequest::operator=(TGetJvmThreadsInfoRequest&& other377) {
  get_complete_info = std::move(other377.get_complete_info);
  return *this;
}
...
TGetJvmThreadsInfoResponse::TGetJvmThreadsInfoResponse(const TGetJvmThreadsInfoResponse& other384) {
  total_thread_count = other384.total_thread_count;
  daemon_thread_count = other384.daemon_thread_count;
  peak_thread_count = other384.peak_thread_count;
  threads = other384.threads;
  __isset = other384.__isset;
}
TGetJvmThreadsInfoResponse::TGetJvmThreadsInfoResponse( TGetJvmThreadsInfoResponse&& other385) {
  total_thread_count = std::move(other385.total_thread_count);
  daemon_thread_count = std::move(other385.daemon_thread_count);
  peak_thread_count = std::move(other385.peak_thread_count);
  threads = std::move(other385.threads);
  __isset = std::move(other385.__isset);
}
TGetJvmThreadsInfoResponse& TGetJvmThreadsInfoResponse::operator=(const TGetJvmThreadsInfoResponse& other386) {
  total_thread_count = other386.total_thread_count;
  daemon_thread_count = other386.daemon_thread_count;
  peak_thread_count = other386.peak_thread_count;
  threads = other386.threads;
  __isset = other386.__isset;
  return *this;
}
TGetJvmThreadsInfoResponse& TGetJvmThreadsInfoResponse::operator=(TGetJvmThreadsInfoResponse&& other387) {
  total_thread_count = std::move(other387.total_thread_count);
  daemon_thread_count = std::move(other387.daemon_thread_count);
  peak_thread_count = std::move(other387.peak_thread_count);
  threads = std::move(other387.threads);
...
TGetJMXJsonResponse::TGetJMXJsonResponse(const TGetJMXJsonResponse& other388) {
  jmx_json = other388.jmx_json;
}
TGetJMXJsonResponse::TGetJMXJsonResponse( TGetJMXJsonResponse&& other389) {
  jmx_json = std::move(other389.jmx_json);
}
TGetJMXJsonResponse& TGetJMXJsonResponse::operator=(const TGetJMXJsonResponse& other390) {
  jmx_json = other390.jmx_json;
  return *this;
}
TGetJMXJsonResponse& TGetJMXJsonResponse::operator=(TGetJMXJsonResponse&& other391) {
  jmx_json = std::move(other391.jmx_json);
  return *this;
}
...
TGetHadoopConfigRequest::TGetHadoopConfigRequest(const TGetHadoopConfigRequest& other392) {
  name = other392.name;
}
TGetHadoopConfigRequest::TGetHadoopConfigRequest( TGetHadoopConfigRequest&& other393) {
  name = std::move(other393.name);
}
TGetHadoopConfigRequest& TGetHadoopConfigRequest::operator=(const TGetHadoopConfigRequest& other394) {
  name = other394.name;
  return *this;
}
TGetHadoopConfigRequest& TGetHadoopConfigRequest::operator=(TGetHadoopConfigRequest&& other395) {
  name = std::move(other395.name);
  return *this;
}
...
TGetHadoopConfigResponse::TGetHadoopConfigResponse(const TGetHadoopConfigResponse& other396) {
  value = other396.value;
  __isset = other396.__isset;
}
TGetHadoopConfigResponse::TGetHadoopConfigResponse( TGetHadoopConfigResponse&& other397) {
  value = std::move(other397.value);
  __isset = std::move(other397.__isset);
}
TGetHadoopConfigResponse& TGetHadoopConfigResponse::operator=(const TGetHadoopConfigResponse& other398) {
  value = other398.value;
  __isset = other398.__isset;
  return *this;
}
TGetHadoopConfigResponse& TGetHadoopConfigResponse::operator=(TGetHadoopConfigResponse&& other399) {
  value = std::move(other399.value);
...
TGetAllHadoopConfigsResponse::TGetAllHadoopConfigsResponse(const TGetAllHadoopConfigsResponse& other408) {
  configs = other408.configs;
  __isset = other408.__isset;
}
TGetAllHadoopConfigsResponse::TGetAllHadoopConfigsResponse( TGetAllHadoopConfigsResponse&& other409) {
  configs = std::move(other409.configs);
  __isset = std::move(other409.__isset);
}
TGetAllHadoopConfigsResponse& TGetAllHadoopConfigsResponse::operator=(const TGetAllHadoopConfigsResponse& other410) {
  configs = other410.configs;
  __isset = other410.__isset;
  return *this;
}
TGetAllHadoopConfigsResponse& TGetAllHadoopConfigsResponse::operator=(TGetAllHadoopConfigsResponse&& other411) {
  configs = std::move(other411.configs);
...
TGetHadoopGroupsRequest::TGetHadoopGroupsRequest(const TGetHadoopGroupsRequest& other412) {
  user = other412.user;
}
TGetHadoopGroupsRequest::TGetHadoopGroupsRequest( TGetHadoopGroupsRequest&& other413) {
  user = std::move(other413.user);
}
TGetHadoopGroupsRequest& TGetHadoopGroupsRequest::operator=(const TGetHadoopGroupsRequest& other414) {
  user = other414.user;
  return *this;
}
TGetHadoopGroupsRequest& TGetHadoopGroupsRequest::operator=(TGetHadoopGroupsRequest&& other415) {
  user = std::move(other415.user);
  return *this;
}
...
TGetHadoopGroupsResponse::TGetHadoopGroupsResponse(const TGetHadoopGroupsResponse& other422) {
  groups = other422.groups;
}
TGetHadoopGroupsResponse::TGetHadoopGroupsResponse( TGetHadoopGroupsResponse&& other423) {
  groups = std::move(other423.groups);
}
TGetHadoopGroupsResponse& TGetHadoopGroupsResponse::operator=(const TGetHadoopGroupsResponse& other424) {
  groups = other424.groups;
  return *this;
}
TGetHadoopGroupsResponse& TGetHadoopGroupsResponse::operator=(TGetHadoopGroupsResponse&& other425) {
  groups = std::move(other425.groups);
  return *this;
}
...
TBuildTestDescriptorTableParams::TBuildTestDescriptorTableParams(const TBuildTestDescriptorTableParams& other438) {
  slot_types = other438.slot_types;
}
TBuildTestDescriptorTableParams::TBuildTestDescriptorTableParams( TBuildTestDescriptorTableParams&& other439) {
  slot_types = std::move(other439.slot_types);
}
TBuildTestDescriptorTableParams& TBuildTestDescriptorTableParams::operator=(const TBuildTestDescriptorTableParams& other440) {
  slot_types = other440.slot_types;
  return *this;
}
TBuildTestDescriptorTableParams& TBuildTestDescriptorTableParams::operator=(TBuildTestDescriptorTableParams&& other441) {
  slot_types = std::move(other441.slot_types);
  return *this;
}
...
TTestCaseData::TTestCaseData(const TTestCaseData& other454) {
  query_stmt = other454.query_stmt;
  tables_and_views = other454.tables_and_views;
  dbs = other454.dbs;
  testcase_data_path = other454.testcase_data_path;
  impala_version = other454.impala_version;
  __isset = other454.__isset;
}
TTestCaseData::TTestCaseData( TTestCaseData&& other455) {
  query_stmt = std::move(other455.query_stmt);
  tables_and_views = std::move(other455.tables_and_views);
  dbs = std::move(other455.dbs);
  testcase_data_path = std::move(other455.testcase_data_path);
  impala_version = std::move(other455.impala_version);
  __isset = std::move(other455.__isset);
}
TTestCaseData& TTestCaseData::operator=(const TTestCaseData& other456) {
  query_stmt = other456.query_stmt;
  tables_and_views = other456.tables_and_views;
  dbs = other456.dbs;
  testcase_data_path = other456.testcase_data_path;
  impala_version = other456.impala_version;
  __isset = other456.__isset;
  return *this;
}
TTestCaseData& TTestCaseData::operator=(TTestCaseData&& other457) {
  query_stmt = std::move(other457.query_stmt);
  tables_and_views = std::move(other457.tables_and_views);
  dbs = std::move(other457.dbs);
  testcase_data_path = std::move(other457.testcase_data_path);
  impala_version = std::move(other457.impala_version);
...
TQueryCompleteContext::TQueryCompleteContext(const TQueryCompleteContext& other458) {
  lineage_string = other458.lineage_string;
}
TQueryCompleteContext::TQueryCompleteContext( TQueryCompleteContext&& other459) {
  lineage_string = std::move(other459.lineage_string);
}
TQueryCompleteContext& TQueryCompleteContext::operator=(const TQueryCompleteContext& other460) {
  lineage_string = other460.lineage_string;
  return *this;
}
TQueryCompleteContext& TQueryCompleteContext::operator=(TQueryCompleteContext&& other461) {
  lineage_string = std::move(other461.lineage_string);
  return *this;
}
...
TWrappedHttpRequest::TWrappedHttpRequest(const TWrappedHttpRequest& other486) {
  method = other486.method;
  server_name = other486.server_name;
  server_port = other486.server_port;
  path = other486.path;
  params = other486.params;
  headers = other486.headers;
  cookies = other486.cookies;
  content = other486.content;
  remote_ip = other486.remote_ip;
  secure = other486.secure;
  __isset = other486.__isset;
}
TWrappedHttpRequest::TWrappedHttpRequest( TWrappedHttpRequest&& other487) {
  method = std::move(other487.method);
  server_name = std::move(other487.server_name);
  server_port = std::move(other487.server_port);
  path = std::move(other487.path);
  params = std::move(other487.params);
  headers = std::move(other487.headers);
  cookies = std::move(other487.cookies);
  content = std::move(other487.content);
  remote_ip = std::move(other487.remote_ip);
  secure = std::move(other487.secure);
  __isset = std::move(other487.__isset);
}
TWrappedHttpRequest& TWrappedHttpRequest::operator=(const TWrappedHttpRequest& other488) {
  method = other488.method;
  server_name = other488.server_name;
  server_port = other488.server_port;
  path = other488.path;
  params = other488.params;
  headers = other488.headers;
  cookies = other488.cookies;
  content = other488.content;
  remote_ip = other488.remote_ip;
  secure = other488.secure;
  __isset = other488.__isset;
  return *this;
}
TWrappedHttpRequest& TWrappedHttpRequest::operator=(TWrappedHttpRequest&& other489) {
  method = std::move(other489.method);
  server_name = std::move(other489.server_name);
  server_port = std::move(other489.server_port);
  path = std::move(other489.path);
  params = std::move(other489.params);
  headers = std::move(other489.headers);
  cookies = std::move(other489.cookies);
  content = std::move(other489.content);
  remote_ip = std::move(other489.remote_ip);
  secure = std::move(other489.secure);
...
TWrappedHttpResponse::TWrappedHttpResponse(const TWrappedHttpResponse& other506) {
  status_code = other506.status_code;
  status_text = other506.status_text;
  headers = other506.headers;
  cookies = other506.cookies;
  content = other506.content;
  content_type = other506.content_type;
  __isset = other506.__isset;
}
TWrappedHttpResponse::TWrappedHttpResponse( TWrappedHttpResponse&& other507) {
  status_code = std::move(other507.status_code);
  status_text = std::move(other507.status_text);
  headers = std::move(other507.headers);
  cookies = std::move(other507.cookies);
  content = std::move(other507.content);
  content_type = std::move(other507.content_type);
  __isset = std::move(other507.__isset);
}
TWrappedHttpResponse& TWrappedHttpResponse::operator=(const TWrappedHttpResponse& other508) {
  status_code = other508.status_code;
  status_text = other508.status_text;
  headers = other508.headers;
  cookies = other508.cookies;
  content = other508.content;
  content_type = other508.content_type;
  __isset = other508.__isset;
  return *this;
}
TWrappedHttpResponse& TWrappedHttpResponse::operator=(TWrappedHttpResponse&& other509) {
  status_code = std::move(other509.status_code);
  status_text = std::move(other509.status_text);
  headers = std::move(other509.headers);
  cookies = std::move(other509.cookies);
  content = std::move(other509.content);
  content_type = std::move(other509.content_type);
