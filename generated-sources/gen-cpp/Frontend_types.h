...
typedef struct _TExecutorGroupSet__isset {
  _TExecutorGroupSet__isset() : curr_num_executors(true), expected_num_executors(true), exec_group_name_prefix(false) {}
  bool curr_num_executors :1;
  bool expected_num_executors :1;
  bool exec_group_name_prefix :1;
} _TExecutorGroupSet__isset;

class TExecutorGroupSet {
 public:

  TExecutorGroupSet(const TExecutorGroupSet&);
  TExecutorGroupSet(TExecutorGroupSet&&);
  TExecutorGroupSet& operator=(const TExecutorGroupSet&);
  TExecutorGroupSet& operator=(TExecutorGroupSet&&);
  TExecutorGroupSet() : curr_num_executors(0), expected_num_executors(0), exec_group_name_prefix() {
  }

  virtual ~TExecutorGroupSet() throw();
  int32_t curr_num_executors;
  int32_t expected_num_executors;
  std::string exec_group_name_prefix;

  _TExecutorGroupSet__isset __isset;

  void __set_curr_num_executors(const int32_t val);

  void __set_expected_num_executors(const int32_t val);

  void __set_exec_group_name_prefix(const std::string& val);
...
typedef struct _TUpdateExecutorMembershipRequest__isset {
  _TUpdateExecutorMembershipRequest__isset() : exec_group_sets(false) {}
  bool exec_group_sets :1;
...
class TUpdateExecutorMembershipRequest {
 public:
  ...
  std::vector<TExecutorGroupSet>  exec_group_sets;
  ...
  void __set_exec_group_sets(const std::vector<TExecutorGroupSet> & val);
