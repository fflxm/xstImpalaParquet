...
MetricDefsConstants::MetricDefsConstants() {
  ...
  tmp156.description = "Total number of backends (both coordinators and executors) registered with the statestore";
  ...
  tmp163.push_back("IMPALAD");

  tmp162.contexts = tmp163;
  tmp162.__isset.contexts = true;
  tmp162.description = "Total number of backends in the executor group set $0 registered with the statestore";
  tmp162.__isset.description = true;
  tmp162.key = "cluster-membership.group-set.backends.total.$0";
  tmp162.__isset.key = true;
  tmp162.kind = ( ::impala::TMetricKind::type)1;
  tmp162.__isset.kind = true;
  tmp162.label = "Total number of executors in the executor group set $0 registered with the statestore";
  tmp162.__isset.label = true;
  tmp162.units = ( ::impala::TUnit::type)7;
  tmp162.__isset.units = true;

  TMetricDefs.insert(std::make_pair("cluster-membership.group-set.backends.total.$0", tmp162));
  TMetricDef tmp164;
  std::vector<std::string>  tmp165;
  tmp165.push_back("IMPALAD");

  tmp164.contexts = tmp165;
  tmp164.__isset.contexts = true;
  tmp164.description = "Total number of executor groups in the executor group set $0 that are in a healthy state, that is, have at least the configured minimum number of executors to be considered for admission";
  tmp164.__isset.description = true;
  tmp164.key = "cluster-membership.group-set.executor-groups.total-healthy.$0";
  tmp164.__isset.key = true;
  tmp164.kind = ( ::impala::TMetricKind::type)1;
  tmp164.__isset.kind = true;
  tmp164.label = "Total number of executor groups in the executor group set $0 that are in a healthy state";
  tmp164.__isset.label = true;
  tmp164.units = ( ::impala::TUnit::type)7;
  tmp164.__isset.units = true;

  TMetricDefs.insert(std::make_pair("cluster-membership.group-set.executor-groups.total-healthy.$0", tmp164));
  TMetricDef tmp166;
  std::vector<std::string>  tmp167;
  tmp167.push_back("IMPALAD");

  tmp166.contexts = tmp167;
  tmp166.__isset.contexts = true;
  tmp166.description = "Total number of executor groups in the executor group set $0 that have at least one executor";
  tmp166.__isset.description = true;
  tmp166.key = "cluster-membership.group-set.executor-groups.total.$0";
  tmp166.__isset.key = true;
  tmp166.kind = ( ::impala::TMetricKind::type)1;
  tmp166.__isset.kind = true;
  tmp166.label = "Total number of executor groups in the executor group set $0 that have at least one executor";
  tmp166.__isset.label = true;
  tmp166.units = ( ::impala::TUnit::type)7;
  tmp166.__isset.units = true;

  TMetricDefs.insert(std::make_pair("cluster-membership.group-set.executor-groups.total.$0", tmp166));
  TMetricDef tmp168;
  ...
  tmp168.description = "Average time taken to fetch a batch of metastore events";
  tmp168.__isset.description = true;
  tmp168.key = "events-processor.avg-events-fetch-duration";
  tmp168.__isset.key = true;
  tmp168.kind = ( ::impala::TMetricKind::type)0;
  tmp168.__isset.kind = true;
  tmp168.label = "Average duration to fetch metastore events";
  tmp168.__isset.label = true;
  tmp168.units = ( ::impala::TUnit::type)9;
  tmp168.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.avg-events-fetch-duration", tmp168));
  TMetricDef tmp170;
  ...
  tmp170.description = "Average time taken to process a batch of events received from metastore";
  tmp170.__isset.description = true;
  tmp170.key = "events-processor.avg-events-process-duration";
  tmp170.__isset.key = true;
  tmp170.kind = ( ::impala::TMetricKind::type)0;
  tmp170.__isset.kind = true;
  tmp170.label = "Average duration to process a batch of metastore events";
  tmp170.__isset.label = true;
  tmp170.units = ( ::impala::TUnit::type)9;
  tmp170.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.avg-events-process-duration", tmp170));
  TMetricDef tmp172;
  ...
  tmp172.description = "Total number of metastore events received";
  tmp172.__isset.description = true;
  tmp172.key = "events-processor.events-received";
  tmp172.__isset.key = true;
  tmp172.kind = ( ::impala::TMetricKind::type)1;
  tmp172.__isset.kind = true;
  tmp172.label = "Total number of metastore events received";
  tmp172.__isset.label = true;
  tmp172.units = ( ::impala::TUnit::type)7;
  tmp172.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.events-received", tmp172));
  TMetricDef tmp174;
  ...
  tmp174.description = "Exponentially weighted moving average (EWMA) of number of events received in last 15 min";
  tmp174.__isset.description = true;
  tmp174.key = "events-processor.events-received-15min-rate";
  tmp174.__isset.key = true;
  tmp174.kind = ( ::impala::TMetricKind::type)0;
  tmp174.__isset.kind = true;
  tmp174.label = "EWMA of number of events received in last 15 min";
  tmp174.__isset.label = true;
  tmp174.units = ( ::impala::TUnit::type)7;
  tmp174.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.events-received-15min-rate", tmp174));
  TMetricDef tmp176;
  ...
  tmp176.description = "Exponentially weighted moving average (EWMA) of number of events received in last 1 min";
  tmp176.__isset.description = true;
  tmp176.key = "events-processor.events-received-1min-rate";
  tmp176.__isset.key = true;
  tmp176.kind = ( ::impala::TMetricKind::type)0;
  tmp176.__isset.kind = true;
  tmp176.label = "EWMA of events received in last 1 min";
  tmp176.__isset.label = true;
  tmp176.units = ( ::impala::TUnit::type)7;
  tmp176.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.events-received-1min-rate", tmp176));
  TMetricDef tmp178;
  ...
  tmp178.description = "Exponentially weighted moving average (EWMA) of number of events received in last 5 min";
  tmp178.__isset.description = true;
  tmp178.key = "events-processor.events-received-5min-rate";
  tmp178.__isset.key = true;
  tmp178.kind = ( ::impala::TMetricKind::type)0;
  tmp178.__isset.kind = true;
  tmp178.label = "EWMA of number of events received in last 5 min";
  tmp178.__isset.label = true;
  tmp178.units = ( ::impala::TUnit::type)7;
  tmp178.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.events-received-5min-rate", tmp178));
  TMetricDef tmp180;
  std::vector<std::string>  tmp181;
  tmp181.push_back("CATALOGSERVER");

  tmp180.contexts = tmp181;
  tmp180.__isset.contexts = true;
  tmp180.description = "Total number of metastore events skipped";
  tmp180.__isset.description = true;
  tmp180.key = "events-processor.events-skipped";
  tmp180.__isset.key = true;
  tmp180.kind = ( ::impala::TMetricKind::type)1;
  tmp180.__isset.kind = true;
  tmp180.label = "Total number of metastore events skipped";
  tmp180.__isset.label = true;
  tmp180.units = ( ::impala::TUnit::type)7;
  tmp180.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.events-skipped", tmp180));
  TMetricDef tmp182;
  std::vector<std::string>  tmp183;
  tmp183.push_back("CATALOGSERVER");

  tmp182.contexts = tmp183;
  tmp182.__isset.contexts = true;
  tmp182.description = "Last metastore event id that the catalog server processed and synced to";
  tmp182.__isset.description = true;
  tmp182.key = "events-processor.last-synced-event-id";
  tmp182.__isset.key = true;
  tmp182.kind = ( ::impala::TMetricKind::type)1;
  tmp182.__isset.kind = true;
  tmp182.label = "Last Synced Event Id";
  tmp182.__isset.label = true;
  tmp182.units = ( ::impala::TUnit::type)7;
  tmp182.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.last-synced-event-id", tmp182));
  TMetricDef tmp184;
  std::vector<std::string>  tmp185;
  tmp185.push_back("CATALOGSERVER");

  tmp184.contexts = tmp185;
  tmp184.__isset.contexts = true;
  tmp184.description = "Metastore event processor status";
  tmp184.__isset.description = true;
  tmp184.key = "events-processor.status";
  tmp184.__isset.key = true;
  tmp184.kind = ( ::impala::TMetricKind::type)2;
  tmp184.__isset.kind = true;
  tmp184.label = "The status of Metastore event processor";
  tmp184.__isset.label = true;
  tmp184.units = ( ::impala::TUnit::type)7;
  tmp184.__isset.units = true;

  TMetricDefs.insert(std::make_pair("events-processor.status", tmp184));
  TMetricDef tmp186;
  ...
  tmp186.description = "Number of cache hits in the External Data Source Class Cache";
  tmp186.__isset.description = true;
  tmp186.key = "external-data-source.class-cache.hits";
  tmp186.__isset.key = true;
  tmp186.kind = ( ::impala::TMetricKind::type)1;
  tmp186.__isset.kind = true;
  tmp186.label = "External Data Source Class Cache Hits";
  tmp186.__isset.label = true;
  tmp186.units = ( ::impala::TUnit::type)0;
  tmp186.__isset.units = true;

  TMetricDefs.insert(std::make_pair("external-data-source.class-cache.hits", tmp186));
  TMetricDef tmp188;
  ...
  tmp188.description = "Number of cache misses in the External Data Source Class Cache";
  tmp188.__isset.description = true;
  tmp188.key = "external-data-source.class-cache.misses";
  tmp188.__isset.key = true;
  tmp188.kind = ( ::impala::TMetricKind::type)1;
  tmp188.__isset.kind = true;
  tmp188.label = "External Data Source Class Cache Misses";
  tmp188.__isset.label = true;
  tmp188.units = ( ::impala::TUnit::type)0;
  tmp188.__isset.units = true;

  TMetricDefs.insert(std::make_pair("external-data-source.class-cache.misses", tmp188));
  TMetricDef tmp190;
  ...
  tmp190.description = "The total number of queries that executed on this backend over the life of the process.";
  tmp190.__isset.description = true;
  tmp190.key = "impala-server.backend-num-queries-executed";
  tmp190.__isset.key = true;
  tmp190.kind = ( ::impala::TMetricKind::type)1;
  tmp190.__isset.kind = true;
  tmp190.label = "Queries Executed On Backend";
  tmp190.__isset.label = true;
  tmp190.units = ( ::impala::TUnit::type)0;
  tmp190.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.backend-num-queries-executed", tmp190));
  TMetricDef tmp192;
  ...
  tmp192.description = "The number of queries currently executing on this backend.";
  tmp192.__isset.description = true;
  tmp192.key = "impala-server.backend-num-queries-executing";
  tmp192.__isset.key = true;
  tmp192.kind = ( ::impala::TMetricKind::type)0;
  tmp192.__isset.kind = true;
  tmp192.label = "Queries Executing On Backend";
  tmp192.__isset.label = true;
  tmp192.units = ( ::impala::TUnit::type)0;
  tmp192.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.backend-num-queries-executing", tmp192));
  TMetricDef tmp194;
  ...
  tmp194.description = "The number of active Impala Backend clients. These clients are for communication with other Impala Daemons.";
  tmp194.__isset.description = true;
  tmp194.key = "impala-server.backends.client-cache.clients-in-use";
  tmp194.__isset.key = true;
  tmp194.kind = ( ::impala::TMetricKind::type)0;
  tmp194.__isset.kind = true;
  tmp194.label = "Impala Backend Active Clients";
  tmp194.__isset.label = true;
  tmp194.units = ( ::impala::TUnit::type)7;
  tmp194.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.backends.client-cache.clients-in-use", tmp194));
  TMetricDef tmp196;
  ...
  tmp196.description = "The total number of Impala Backend clients in this Impala Daemon's client cache. These clients are for communication with other Impala Daemons.";
  tmp196.__isset.description = true;
  tmp196.key = "impala-server.backends.client-cache.total-clients";
  tmp196.__isset.key = true;
  tmp196.kind = ( ::impala::TMetricKind::type)0;
  tmp196.__isset.kind = true;
  tmp196.label = "Impala Backend Total Clients";
  tmp196.__isset.label = true;
  tmp196.units = ( ::impala::TUnit::type)7;
  tmp196.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.backends.client-cache.total-clients", tmp196));
  TMetricDef tmp198;
  ...
  tmp198.description = "Distribution of DDL operation latencies";
  tmp198.__isset.description = true;
  tmp198.key = "impala-server.ddl-durations-ms";
  tmp198.__isset.key = true;
  tmp198.kind = ( ::impala::TMetricKind::type)5;
  tmp198.__isset.kind = true;
  tmp198.label = "DDL latency distribution";
  tmp198.__isset.label = true;
  tmp198.units = ( ::impala::TUnit::type)8;
  tmp198.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.ddl-durations-ms", tmp198));
  TMetricDef tmp200;
  ...
  tmp200.description = "The total number of hedged reads attempted over the life of the process";
  tmp200.__isset.description = true;
  tmp200.key = "impala-server.hedged-read-ops";
  tmp200.__isset.key = true;
  tmp200.kind = ( ::impala::TMetricKind::type)1;
  tmp200.__isset.kind = true;
  tmp200.label = "Hedged Read Operations";
  tmp200.__isset.label = true;
  tmp200.units = ( ::impala::TUnit::type)0;
  tmp200.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.hedged-read-ops", tmp200));
  TMetricDef tmp202;
  ...
  tmp202.description = "The total number of times hedged reads were faster than regular read operations";
  tmp202.__isset.description = true;
  tmp202.key = "impala-server.hedged-read-ops-win";
  tmp202.__isset.key = true;
  tmp202.kind = ( ::impala::TMetricKind::type)1;
  tmp202.__isset.kind = true;
  tmp202.label = "Hedged Read Operations Won";
  tmp202.__isset.label = true;
  tmp202.units = ( ::impala::TUnit::type)0;
  tmp202.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.hedged-read-ops-win", tmp202));
  TMetricDef tmp204;
  ...
  tmp204.description = "The total number of bytes read by the IO manager.";
  tmp204.__isset.description = true;
  tmp204.key = "impala-server.io-mgr.bytes-read";
  tmp204.__isset.key = true;
  tmp204.kind = ( ::impala::TMetricKind::type)1;
  tmp204.__isset.kind = true;
  tmp204.label = "Impala Server Io Mgr Bytes Read";
  tmp204.__isset.label = true;
  tmp204.units = ( ::impala::TUnit::type)3;
  tmp204.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.bytes-read", tmp204));
  TMetricDef tmp206;
  ...
  tmp206.description = "Total number of bytes written to disk by the IO manager.";
  tmp206.__isset.description = true;
  tmp206.key = "impala-server.io-mgr.bytes-written";
  tmp206.__isset.key = true;
  tmp206.kind = ( ::impala::TMetricKind::type)1;
  tmp206.__isset.kind = true;
  tmp206.label = "Impala Server Io Mgr Bytes Written";
  tmp206.__isset.label = true;
  tmp206.units = ( ::impala::TUnit::type)3;
  tmp206.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.bytes-written", tmp206));
  TMetricDef tmp208;
  ...
  tmp208.description = "Total number of cached bytes read by the IO manager.";
  tmp208.__isset.description = true;
  tmp208.key = "impala-server.io-mgr.cached-bytes-read";
  tmp208.__isset.key = true;
  tmp208.kind = ( ::impala::TMetricKind::type)1;
  tmp208.__isset.kind = true;
  tmp208.label = "Impala Server Io Mgr Cached Bytes Read";
  tmp208.__isset.label = true;
  tmp208.units = ( ::impala::TUnit::type)3;
  tmp208.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.cached-bytes-read", tmp208));
  TMetricDef tmp210;
  ...
  tmp210.description = "Total number of local bytes read by the IO manager.";
  tmp210.__isset.description = true;
  tmp210.key = "impala-server.io-mgr.local-bytes-read";
  tmp210.__isset.key = true;
  tmp210.kind = ( ::impala::TMetricKind::type)1;
  tmp210.__isset.kind = true;
  tmp210.label = "Impala Server Io Mgr Local Bytes Read";
  tmp210.__isset.label = true;
  tmp210.units = ( ::impala::TUnit::type)3;
  tmp210.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.local-bytes-read", tmp210));
  TMetricDef tmp212;
  ...
  tmp212.description = "The number of allocated IO buffers. IO buffers are shared by all queries.";
  tmp212.__isset.description = true;
  tmp212.key = "impala-server.io-mgr.num-buffers";
  tmp212.__isset.key = true;
  tmp212.kind = ( ::impala::TMetricKind::type)0;
  tmp212.__isset.kind = true;
  tmp212.label = "IO Buffers";
  tmp212.__isset.label = true;
  tmp212.units = ( ::impala::TUnit::type)7;
  tmp212.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.num-buffers", tmp212));
  TMetricDef tmp214;
  ...
  tmp214.description = "The current number of files opened by the IO Manager";
  tmp214.__isset.description = true;
  tmp214.key = "impala-server.io-mgr.num-open-files";
  tmp214.__isset.key = true;
  tmp214.kind = ( ::impala::TMetricKind::type)0;
  tmp214.__isset.kind = true;
  tmp214.label = "Open Files";
  tmp214.__isset.label = true;
  tmp214.units = ( ::impala::TUnit::type)7;
  tmp214.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.num-open-files", tmp214));
  TMetricDef tmp216;
  ...
  tmp216.description = "The number of unused IO buffers. IO buffers are shared by all queries.";
  tmp216.__isset.description = true;
  tmp216.key = "impala-server.io-mgr.num-unused-buffers";
  tmp216.__isset.key = true;
  tmp216.kind = ( ::impala::TMetricKind::type)0;
  tmp216.__isset.kind = true;
  tmp216.label = "Unused IO Buffers";
  tmp216.__isset.label = true;
  tmp216.units = ( ::impala::TUnit::type)7;
  tmp216.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.num-unused-buffers", tmp216));
  TMetricDef tmp218;
  ...
  tmp218.description = "IO Manager device name.";
  tmp218.__isset.description = true;
  tmp218.key = "impala-server.io-mgr.queue-$0.device-name";
  tmp218.__isset.key = true;
  tmp218.kind = ( ::impala::TMetricKind::type)2;
  tmp218.__isset.kind = true;
  tmp218.label = "Impala Server Io Mgr Queue Device Name";
  tmp218.__isset.label = true;
  tmp218.units = ( ::impala::TUnit::type)7;
  tmp218.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.queue-$0.device-name", tmp218));
  TMetricDef tmp220;
  ...
  tmp220.description = "Histogram of read operation times on disk.";
  tmp220.__isset.description = true;
  tmp220.key = "impala-server.io-mgr.queue-$0.read-latency";
  tmp220.__isset.key = true;
  tmp220.kind = ( ::impala::TMetricKind::type)5;
  tmp220.__isset.kind = true;
  tmp220.label = "Impala Server Io Mgr Read Latency Histogram";
  tmp220.__isset.label = true;
  tmp220.units = ( ::impala::TUnit::type)5;
  tmp220.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.queue-$0.read-latency", tmp220));
  TMetricDef tmp222;
  ...
  tmp222.description = "Histogram of read operation sizes on disk.";
  tmp222.__isset.description = true;
  tmp222.key = "impala-server.io-mgr.queue-$0.read-size";
  tmp222.__isset.key = true;
  tmp222.kind = ( ::impala::TMetricKind::type)5;
  tmp222.__isset.kind = true;
  tmp222.label = "Impala Server Io Mgr Read Size Histogram";
  tmp222.__isset.label = true;
  tmp222.units = ( ::impala::TUnit::type)3;
  tmp222.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.queue-$0.read-size", tmp222));
  TMetricDef tmp224;
  ...
  tmp224.description = "The number of write io errors on disk.";
  tmp224.__isset.description = true;
  tmp224.key = "impala-server.io-mgr.queue-$0.write-io-error";
  tmp224.__isset.key = true;
  tmp224.kind = ( ::impala::TMetricKind::type)1;
  tmp224.__isset.kind = true;
  tmp224.label = "Impala Server Io Mgr Write IO Error Count";
  tmp224.__isset.label = true;
  tmp224.units = ( ::impala::TUnit::type)7;
  tmp224.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.queue-$0.write-io-error", tmp224));
  TMetricDef tmp226;
  ...
  tmp226.description = "Histogram of write operation times on disk.";
  tmp226.__isset.description = true;
  tmp226.key = "impala-server.io-mgr.queue-$0.write-latency";
  tmp226.__isset.key = true;
  tmp226.kind = ( ::impala::TMetricKind::type)5;
  tmp226.__isset.kind = true;
  tmp226.label = "Impala Server Io Mgr Write Latency Histogram";
  tmp226.__isset.label = true;
  tmp226.units = ( ::impala::TUnit::type)5;
  tmp226.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.queue-$0.write-latency", tmp226));
  TMetricDef tmp228;
  ...
  tmp228.description = "Histogram of write operation sizes on disk.";
  tmp228.__isset.description = true;
  tmp228.key = "impala-server.io-mgr.queue-$0.write-size";
  tmp228.__isset.key = true;
  tmp228.kind = ( ::impala::TMetricKind::type)5;
  tmp228.__isset.kind = true;
  tmp228.label = "Impala Server Io Mgr Write Size Histogram";
  tmp228.__isset.label = true;
  tmp228.units = ( ::impala::TUnit::type)3;
  tmp228.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.queue-$0.write-size", tmp228));
  TMetricDef tmp230;
  ...
  tmp230.description = "Total number of bytes not inserted in remote data cache due to concurrency limit.";
  tmp230.__isset.description = true;
  tmp230.key = "impala-server.io-mgr.remote-data-cache-dropped-bytes";
  tmp230.__isset.key = true;
  tmp230.kind = ( ::impala::TMetricKind::type)1;
  tmp230.__isset.kind = true;
  tmp230.label = "Impala Server Io Mgr Remote Data Cache Bytes Not Inserted Due To Concurrency limit";
  tmp230.__isset.label = true;
  tmp230.units = ( ::impala::TUnit::type)3;
  tmp230.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-dropped-bytes", tmp230));
  TMetricDef tmp232;
  ...
  tmp232.description = "Total number of entries not inserted in remote data cache due to concurrency limit.";
  tmp232.__isset.description = true;
  tmp232.key = "impala-server.io-mgr.remote-data-cache-dropped-entries";
  tmp232.__isset.key = true;
  tmp232.kind = ( ::impala::TMetricKind::type)1;
  tmp232.__isset.kind = true;
  tmp232.label = "Impala Server Io Mgr Remote Data Cache Entries Not Inserted Due To Concurrency Limit";
  tmp232.__isset.label = true;
  tmp232.units = ( ::impala::TUnit::type)0;
  tmp232.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-dropped-entries", tmp232));
  TMetricDef tmp234;
  ...
  tmp234.description = "Total number of bytes of hits in the remote data cache.";
  tmp234.__isset.description = true;
  tmp234.key = "impala-server.io-mgr.remote-data-cache-hit-bytes";
  tmp234.__isset.key = true;
  tmp234.kind = ( ::impala::TMetricKind::type)1;
  tmp234.__isset.kind = true;
  tmp234.label = "Impala Server Io Mgr Remote Data Cache Hit In Bytes";
  tmp234.__isset.label = true;
  tmp234.units = ( ::impala::TUnit::type)3;
  tmp234.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-hit-bytes", tmp234));
  TMetricDef tmp236;
  ...
  tmp236.description = "Total number of hits in the remote data cache.";
  tmp236.__isset.description = true;
  tmp236.key = "impala-server.io-mgr.remote-data-cache-hit-count";
  tmp236.__isset.key = true;
  tmp236.kind = ( ::impala::TMetricKind::type)1;
  tmp236.__isset.kind = true;
  tmp236.label = "Impala Server Io Mgr Remote Data Cache Hit Count";
  tmp236.__isset.label = true;
  tmp236.units = ( ::impala::TUnit::type)0;
  tmp236.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-hit-count", tmp236));
  TMetricDef tmp238;
  ...
  tmp238.description = "Total number of instantaneous evictions from the remote data cache. An instantaneous eviction happens when the eviction policy rejects an entry during insert.";
  tmp238.__isset.description = true;
  tmp238.key = "impala-server.io-mgr.remote-data-cache-instant-evictions";
  tmp238.__isset.key = true;
  tmp238.kind = ( ::impala::TMetricKind::type)1;
  tmp238.__isset.kind = true;
  tmp238.label = "Impala Server Io Mgr Remote Data Cache Num Instant Evictions";
  tmp238.__isset.label = true;
  tmp238.units = ( ::impala::TUnit::type)0;
  tmp238.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-instant-evictions", tmp238));
  TMetricDef tmp240;
  ...
  tmp240.description = "Total number of bytes of misses in the remote data cache.";
  tmp240.__isset.description = true;
  tmp240.key = "impala-server.io-mgr.remote-data-cache-miss-bytes";
  tmp240.__isset.key = true;
  tmp240.kind = ( ::impala::TMetricKind::type)1;
  tmp240.__isset.kind = true;
  tmp240.label = "Impala Server Io Mgr Remote Data Cache Miss In Bytes";
  tmp240.__isset.label = true;
  tmp240.units = ( ::impala::TUnit::type)3;
  tmp240.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-miss-bytes", tmp240));
  TMetricDef tmp242;
  ...
  tmp242.description = "Total number of misses in the remote data cache.";
  tmp242.__isset.description = true;
  tmp242.key = "impala-server.io-mgr.remote-data-cache-miss-count";
  tmp242.__isset.key = true;
  tmp242.kind = ( ::impala::TMetricKind::type)1;
  tmp242.__isset.kind = true;
  tmp242.label = "Impala Server Io Mgr Remote Data Cache Miss Count";
  tmp242.__isset.label = true;
  tmp242.units = ( ::impala::TUnit::type)0;
  tmp242.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-miss-count", tmp242));
  TMetricDef tmp244;
  ...
  tmp244.description = "Current number of entries in the remote data cache.";
  tmp244.__isset.description = true;
  tmp244.key = "impala-server.io-mgr.remote-data-cache-num-entries";
  tmp244.__isset.key = true;
  tmp244.kind = ( ::impala::TMetricKind::type)0;
  tmp244.__isset.kind = true;
  tmp244.label = "Impala Server Io Mgr Remote Data Cache Num Entries";
  tmp244.__isset.label = true;
  tmp244.units = ( ::impala::TUnit::type)0;
  tmp244.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-num-entries", tmp244));
  TMetricDef tmp246;
  ...
  tmp246.description = "Total number of writes into the remote data cache.";
  tmp246.__isset.description = true;
  tmp246.key = "impala-server.io-mgr.remote-data-cache-num-writes";
  tmp246.__isset.key = true;
  tmp246.kind = ( ::impala::TMetricKind::type)1;
  tmp246.__isset.kind = true;
  tmp246.label = "Impala Server Io Mgr Remote Data Cache Num Writes";
  tmp246.__isset.label = true;
  tmp246.units = ( ::impala::TUnit::type)0;
  tmp246.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-num-writes", tmp246));
  TMetricDef tmp248;
  ...
  tmp248.description = "Histogram of eviction operation times for data cache partition";
  tmp248.__isset.description = true;
  tmp248.key = "impala-server.io-mgr.remote-data-cache-partition-$0.eviction-latency";
  tmp248.__isset.key = true;
  tmp248.kind = ( ::impala::TMetricKind::type)5;
  tmp248.__isset.kind = true;
  tmp248.label = "Impala Server Io Mgr Remote Data Cache Partition Eviction Latency";
  tmp248.__isset.label = true;
  tmp248.units = ( ::impala::TUnit::type)5;
  tmp248.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-partition-$0.eviction-latency", tmp248));
  TMetricDef tmp250;
  ...
  tmp250.description = "Data Cache Partition Path";
  tmp250.__isset.description = true;
  tmp250.key = "impala-server.io-mgr.remote-data-cache-partition-$0.path";
  tmp250.__isset.key = true;
  tmp250.kind = ( ::impala::TMetricKind::type)2;
  tmp250.__isset.kind = true;
  tmp250.label = "Impala Server Io Mgr Remote Data Cache Partition Path";
  tmp250.__isset.label = true;
  tmp250.units = ( ::impala::TUnit::type)7;
  tmp250.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-partition-$0.path", tmp250));
  TMetricDef tmp252;
  ...
  tmp252.description = "Histogram of read operation times for data cache partition";
  tmp252.__isset.description = true;
  tmp252.key = "impala-server.io-mgr.remote-data-cache-partition-$0.read-latency";
  tmp252.__isset.key = true;
  tmp252.kind = ( ::impala::TMetricKind::type)5;
  tmp252.__isset.kind = true;
  tmp252.label = "Impala Server Io Mgr Remote Data Cache Partition Read Latency";
  tmp252.__isset.label = true;
  tmp252.units = ( ::impala::TUnit::type)5;
  tmp252.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-partition-$0.read-latency", tmp252));
  TMetricDef tmp254;
  ...
  tmp254.description = "Histogram of write operation times for data cache partition";
  tmp254.__isset.description = true;
  tmp254.key = "impala-server.io-mgr.remote-data-cache-partition-$0.write-latency";
  tmp254.__isset.key = true;
  tmp254.kind = ( ::impala::TMetricKind::type)5;
  tmp254.__isset.kind = true;
  tmp254.label = "Impala Server Io Mgr Remote Data Cache Partition Write Latency";
  tmp254.__isset.label = true;
  tmp254.units = ( ::impala::TUnit::type)5;
  tmp254.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-partition-$0.write-latency", tmp254));
  TMetricDef tmp256;
  ...
  tmp256.description = "Current byte size of the remote data cache.";
  tmp256.__isset.description = true;
  tmp256.key = "impala-server.io-mgr.remote-data-cache-total-bytes";
  tmp256.__isset.key = true;
  tmp256.kind = ( ::impala::TMetricKind::type)0;
  tmp256.__isset.kind = true;
  tmp256.label = "Impala Server Io Mgr Remote Data Cache Bytes Size";
  tmp256.__isset.label = true;
  tmp256.units = ( ::impala::TUnit::type)3;
  tmp256.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.remote-data-cache-total-bytes", tmp256));
  TMetricDef tmp258;
  ...
  tmp258.description = "Total number of short-circuit bytes read by the IO manager.";
  tmp258.__isset.description = true;
  tmp258.key = "impala-server.io-mgr.short-circuit-bytes-read";
  tmp258.__isset.key = true;
  tmp258.kind = ( ::impala::TMetricKind::type)1;
  tmp258.__isset.kind = true;
  tmp258.label = "Impala Server Io Mgr Short Circuit Bytes Read";
  tmp258.__isset.label = true;
  tmp258.units = ( ::impala::TUnit::type)3;
  tmp258.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.short-circuit-bytes-read", tmp258));
  TMetricDef tmp260;
  ...
  tmp260.description = "Number of bytes used by IO buffers (used and unused).";
  tmp260.__isset.description = true;
  tmp260.key = "impala-server.io-mgr.total-bytes";
  tmp260.__isset.key = true;
  tmp260.kind = ( ::impala::TMetricKind::type)0;
  tmp260.__isset.kind = true;
  tmp260.label = "IO Buffers Total Size";
  tmp260.__isset.label = true;
  tmp260.units = ( ::impala::TUnit::type)3;
  tmp260.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io-mgr.total-bytes", tmp260));
  TMetricDef tmp262;
  ...
  tmp262.description = "Number of cache hits for cached HDFS file handles";
  tmp262.__isset.description = true;
  tmp262.key = "impala-server.io.mgr.cached-file-handles-hit-count";
  tmp262.__isset.key = true;
  tmp262.kind = ( ::impala::TMetricKind::type)0;
  tmp262.__isset.kind = true;
  tmp262.label = "HDFS cached file handles hit count";
  tmp262.__isset.label = true;
  tmp262.units = ( ::impala::TUnit::type)7;
  tmp262.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io.mgr.cached-file-handles-hit-count", tmp262));
  TMetricDef tmp264;
  ...
  tmp264.description = "HDFS file handle cache hit ratio, between 0 and 1, where 1 means all reads were served from cached file handles.";
  tmp264.__isset.description = true;
  tmp264.key = "impala-server.io.mgr.cached-file-handles-hit-ratio";
  tmp264.__isset.key = true;
  tmp264.kind = ( ::impala::TMetricKind::type)3;
  tmp264.__isset.kind = true;
  tmp264.label = "HDFS file handle cache hit ratio";
  tmp264.__isset.label = true;
  tmp264.units = ( ::impala::TUnit::type)7;
  tmp264.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io.mgr.cached-file-handles-hit-ratio", tmp264));
  TMetricDef tmp266;
  ...
  tmp266.description = "Number of cache misses for cached HDFS file handles";
  tmp266.__isset.description = true;
  tmp266.key = "impala-server.io.mgr.cached-file-handles-miss-count";
  tmp266.__isset.key = true;
  tmp266.kind = ( ::impala::TMetricKind::type)0;
  tmp266.__isset.kind = true;
  tmp266.label = "HDFS cached file handles miss count";
  tmp266.__isset.label = true;
  tmp266.units = ( ::impala::TUnit::type)7;
  tmp266.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io.mgr.cached-file-handles-miss-count", tmp266));
  TMetricDef tmp268;
  ...
  tmp268.description = "Number of cached HDFS file handles reopened";
  tmp268.__isset.description = true;
  tmp268.key = "impala-server.io.mgr.cached-file-handles-reopened";
  tmp268.__isset.key = true;
  tmp268.kind = ( ::impala::TMetricKind::type)1;
  tmp268.__isset.kind = true;
  tmp268.label = "HDFS cached file handles reopened";
  tmp268.__isset.label = true;
  tmp268.units = ( ::impala::TUnit::type)7;
  tmp268.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io.mgr.cached-file-handles-reopened", tmp268));
  TMetricDef tmp270;
  ...
  tmp270.description = "Number of currently cached HDFS file handles in the IO manager.";
  tmp270.__isset.description = true;
  tmp270.key = "impala-server.io.mgr.num-cached-file-handles";
  tmp270.__isset.key = true;
  tmp270.kind = ( ::impala::TMetricKind::type)0;
  tmp270.__isset.kind = true;
  tmp270.label = "Number of cached HDFS file handles";
  tmp270.__isset.label = true;
  tmp270.units = ( ::impala::TUnit::type)7;
  tmp270.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io.mgr.num-cached-file-handles", tmp270));
  TMetricDef tmp272;
  ...
  tmp272.description = "Number of HDFS file handles that are currently in use by readers.";
  tmp272.__isset.description = true;
  tmp272.key = "impala-server.io.mgr.num-file-handles-outstanding";
  tmp272.__isset.key = true;
  tmp272.kind = ( ::impala::TMetricKind::type)0;
  tmp272.__isset.kind = true;
  tmp272.label = "Number of outstanding HDFS file handles";
  tmp272.__isset.label = true;
  tmp272.units = ( ::impala::TUnit::type)7;
  tmp272.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.io.mgr.num-file-handles-outstanding", tmp272));
  TMetricDef tmp274;
  ...
  tmp274.description = "The number of HDFS files currently open for writing.";
  tmp274.__isset.description = true;
  tmp274.key = "impala-server.num-files-open-for-insert";
  tmp274.__isset.key = true;
  tmp274.kind = ( ::impala::TMetricKind::type)0;
  tmp274.__isset.kind = true;
  tmp274.label = "Files Open For Insert";
  tmp274.__isset.label = true;
  tmp274.units = ( ::impala::TUnit::type)7;
  tmp274.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-files-open-for-insert", tmp274));
  TMetricDef tmp276;
  ...
  tmp276.description = "The total number of query fragments processed over the life of the process.";
  tmp276.__isset.description = true;
  tmp276.key = "impala-server.num-fragments";
  tmp276.__isset.key = true;
  tmp276.kind = ( ::impala::TMetricKind::type)1;
  tmp276.__isset.kind = true;
  tmp276.label = "Query Fragment Instances";
  tmp276.__isset.label = true;
  tmp276.units = ( ::impala::TUnit::type)0;
  tmp276.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-fragments", tmp276));
  TMetricDef tmp278;
  ...
  tmp278.description = "The number of query fragment instances currently executing.";
  tmp278.__isset.description = true;
  tmp278.key = "impala-server.num-fragments-in-flight";
  tmp278.__isset.key = true;
  tmp278.kind = ( ::impala::TMetricKind::type)0;
  tmp278.__isset.kind = true;
  tmp278.label = "Query Fragment Instances Executing";
  tmp278.__isset.label = true;
  tmp278.units = ( ::impala::TUnit::type)0;
  tmp278.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-fragments-in-flight", tmp278));
  TMetricDef tmp280;
  ...
  tmp280.description = "The number of open Beeswax sessions.";
  tmp280.__isset.description = true;
  tmp280.key = "impala-server.num-open-beeswax-sessions";
  tmp280.__isset.key = true;
  tmp280.kind = ( ::impala::TMetricKind::type)0;
  tmp280.__isset.kind = true;
  tmp280.label = "Beeswax Sessions";
  tmp280.__isset.label = true;
  tmp280.units = ( ::impala::TUnit::type)7;
  tmp280.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-open-beeswax-sessions", tmp280));
  TMetricDef tmp282;
  ...
  tmp282.description = "The number of open HiveServer2 sessions.";
  tmp282.__isset.description = true;
  tmp282.key = "impala-server.num-open-hiveserver2-sessions";
  tmp282.__isset.key = true;
  tmp282.kind = ( ::impala::TMetricKind::type)0;
  tmp282.__isset.kind = true;
  tmp282.label = "HiveServer2 Sessions";
  tmp282.__isset.label = true;
  tmp282.units = ( ::impala::TUnit::type)7;
  tmp282.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-open-hiveserver2-sessions", tmp282));
  TMetricDef tmp284;
  ...
  tmp284.description = "The total number of queries processed over the life of the process";
  tmp284.__isset.description = true;
  tmp284.key = "impala-server.num-queries";
  tmp284.__isset.key = true;
  tmp284.kind = ( ::impala::TMetricKind::type)1;
  tmp284.__isset.kind = true;
  tmp284.label = "Queries";
  tmp284.__isset.label = true;
  tmp284.units = ( ::impala::TUnit::type)0;
  tmp284.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-queries", tmp284));
  TMetricDef tmp286;
  ...
  tmp286.description = "Number of queries expired due to inactivity.";
  tmp286.__isset.description = true;
  tmp286.key = "impala-server.num-queries-expired";
  tmp286.__isset.key = true;
  tmp286.kind = ( ::impala::TMetricKind::type)1;
  tmp286.__isset.kind = true;
  tmp286.label = "Queries Expired";
  tmp286.__isset.label = true;
  tmp286.units = ( ::impala::TUnit::type)0;
  tmp286.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-queries-expired", tmp286));
  TMetricDef tmp288;
  ...
  tmp288.description = "The total number of queries registered on this Impala server instance. Includes queries that are in flight and waiting to be closed";
  tmp288.__isset.description = true;
  tmp288.key = "impala-server.num-queries-registered";
  tmp288.__isset.key = true;
  tmp288.kind = ( ::impala::TMetricKind::type)0;
  tmp288.__isset.kind = true;
  tmp288.label = "Queries Registered";
  tmp288.__isset.label = true;
  tmp288.units = ( ::impala::TUnit::type)0;
  tmp288.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-queries-registered", tmp288));
  TMetricDef tmp290;
  ...
  tmp290.description = "Number of queries for which any operator spilled.";
  tmp290.__isset.description = true;
  tmp290.key = "impala-server.num-queries-spilled";
  tmp290.__isset.key = true;
  tmp290.kind = ( ::impala::TMetricKind::type)1;
  tmp290.__isset.kind = true;
  tmp290.label = "Impala Server Num Queries Spilled";
  tmp290.__isset.label = true;
  tmp290.units = ( ::impala::TUnit::type)0;
  tmp290.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-queries-spilled", tmp290));
  TMetricDef tmp292;
  ...
  tmp292.description = "Number of sessions expired due to inactivity.";
  tmp292.__isset.description = true;
  tmp292.key = "impala-server.num-sessions-expired";
  tmp292.__isset.key = true;
  tmp292.kind = ( ::impala::TMetricKind::type)1;
  tmp292.__isset.kind = true;
  tmp292.label = "Sessions Expired";
  tmp292.__isset.label = true;
  tmp292.units = ( ::impala::TUnit::type)0;
  tmp292.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.num-sessions-expired", tmp292));
  TMetricDef tmp294;
  ...
  tmp294.description = "Distribution of query latencies";
  tmp294.__isset.description = true;
  tmp294.key = "impala-server.query-durations-ms";
  tmp294.__isset.key = true;
  tmp294.kind = ( ::impala::TMetricKind::type)5;
  tmp294.__isset.kind = true;
  tmp294.label = "Query latency distribution";
  tmp294.__isset.label = true;
  tmp294.units = ( ::impala::TUnit::type)8;
  tmp294.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.query-durations-ms", tmp294));
  TMetricDef tmp296;
  ...
  tmp296.description = "Indicates if the Impala Server is ready.";
  tmp296.__isset.description = true;
  tmp296.key = "impala-server.ready";
  tmp296.__isset.key = true;
  tmp296.kind = ( ::impala::TMetricKind::type)2;
  tmp296.__isset.kind = true;
  tmp296.label = "Impala Server Ready";
  tmp296.__isset.label = true;
  tmp296.units = ( ::impala::TUnit::type)7;
  tmp296.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.ready", tmp296));
  TMetricDef tmp298;
  ...
  tmp298.description = "Total number of bytes consumed for rows cached to support HS2 FETCH_FIRST.";
  tmp298.__isset.description = true;
  tmp298.key = "impala-server.resultset-cache.total-bytes";
  tmp298.__isset.key = true;
  tmp298.kind = ( ::impala::TMetricKind::type)0;
  tmp298.__isset.kind = true;
  tmp298.label = "Impala Server Resultset Cache Total Bytes";
  tmp298.__isset.label = true;
  tmp298.units = ( ::impala::TUnit::type)7;
  tmp298.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.resultset-cache.total-bytes", tmp298));
  TMetricDef tmp300;
  ...
  tmp300.description = "Total number of rows cached to support HS2 FETCH_FIRST.";
  tmp300.__isset.description = true;
  tmp300.key = "impala-server.resultset-cache.total-num-rows";
  tmp300.__isset.key = true;
  tmp300.kind = ( ::impala::TMetricKind::type)0;
  tmp300.__isset.kind = true;
  tmp300.label = "Impala Server Resultset Cache Total Num Rows";
  tmp300.__isset.label = true;
  tmp300.units = ( ::impala::TUnit::type)7;
  tmp300.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.resultset-cache.total-num-rows", tmp300));
  TMetricDef tmp302;
  ...
  tmp302.description = "The total number of scan ranges read over the life of the process that did not have volume metadata";
  tmp302.__isset.description = true;
  tmp302.key = "impala-server.scan-ranges.num-missing-volume-id";
  tmp302.__isset.key = true;
  tmp302.kind = ( ::impala::TMetricKind::type)1;
  tmp302.__isset.kind = true;
  tmp302.label = "Scan Ranges Missing Volume Information";
  tmp302.__isset.label = true;
  tmp302.units = ( ::impala::TUnit::type)0;
  tmp302.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.scan-ranges.num-missing-volume-id", tmp302));
  TMetricDef tmp304;
  std::vector<std::string>  tmp305;
  tmp305.push_back("IMPALAD");

  tmp304.contexts = tmp305;
  tmp304.__isset.contexts = true;
  tmp304.description = "The total number of scan ranges read over the life of the process";
  tmp304.__isset.description = true;
  tmp304.key = "impala-server.scan-ranges.total";
  tmp304.__isset.key = true;
  tmp304.kind = ( ::impala::TMetricKind::type)1;
  tmp304.__isset.kind = true;
  tmp304.label = "Scan Ranges";
  tmp304.__isset.label = true;
  tmp304.units = ( ::impala::TUnit::type)0;
  tmp304.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.scan-ranges.total", tmp304));
  TMetricDef tmp306;
  std::vector<std::string>  tmp307;
  tmp307.push_back("IMPALAD");

  tmp306.contexts = tmp307;
  tmp306.__isset.contexts = true;
  tmp306.description = "The full version string of the Impala Server.";
  tmp306.__isset.description = true;
  tmp306.key = "impala-server.version";
  tmp306.__isset.key = true;
  tmp306.kind = ( ::impala::TMetricKind::type)2;
  tmp306.__isset.kind = true;
  tmp306.label = "Impala Server Version";
  tmp306.__isset.label = true;
  tmp306.units = ( ::impala::TUnit::type)7;
  tmp306.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala-server.version", tmp306));
  TMetricDef tmp308;
  std::vector<std::string>  tmp309;
  tmp309.push_back("IMPALAD");

  tmp308.contexts = tmp309;
  tmp308.__isset.contexts = true;
  tmp308.description = "The number of times the FAIL debug action returned an error. For testing only.";
  tmp308.__isset.description = true;
  tmp308.key = "impala.debug_action.fail";
  tmp308.__isset.key = true;
  tmp308.kind = ( ::impala::TMetricKind::type)1;
  tmp308.__isset.kind = true;
  tmp308.label = "FAIL debug action hits";
  tmp308.__isset.label = true;
  tmp308.units = ( ::impala::TUnit::type)7;
  tmp308.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.debug_action.fail", tmp308));
  TMetricDef tmp310;
  ...
  tmp310.description = "The number of connections to the Catalog Service that have been accepted and are waiting to be setup.";
  tmp310.__isset.description = true;
  tmp310.key = "impala.thrift-server.CatalogService.connection-setup-queue-size";
  tmp310.__isset.key = true;
  tmp310.kind = ( ::impala::TMetricKind::type)0;
  tmp310.__isset.kind = true;
  tmp310.label = "Catalog Service Connections Queued for Setup";
  tmp310.__isset.label = true;
  tmp310.units = ( ::impala::TUnit::type)7;
  tmp310.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.CatalogService.connection-setup-queue-size", tmp310));
  TMetricDef tmp312;
  ...
  tmp312.description = "Amount of time clients of Catalog Service spent waiting for connection to be set up";
  tmp312.__isset.description = true;
  tmp312.key = "impala.thrift-server.CatalogService.connection-setup-time";
  tmp312.__isset.key = true;
  tmp312.kind = ( ::impala::TMetricKind::type)5;
  tmp312.__isset.kind = true;
  tmp312.label = "Catalog Service client connection setup time";
  tmp312.__isset.label = true;
  tmp312.units = ( ::impala::TUnit::type)10;
  tmp312.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.CatalogService.connection-setup-time", tmp312));
  TMetricDef tmp314;
  ...
  tmp314.description = "The number of active catalog service connections to this Catalog Server.";
  tmp314.__isset.description = true;
  tmp314.key = "impala.thrift-server.CatalogService.connections-in-use";
  tmp314.__isset.key = true;
  tmp314.kind = ( ::impala::TMetricKind::type)0;
  tmp314.__isset.kind = true;
  tmp314.label = "Catalog Service Active Connections";
  tmp314.__isset.label = true;
  tmp314.units = ( ::impala::TUnit::type)7;
  tmp314.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.CatalogService.connections-in-use", tmp314));
  TMetricDef tmp316;
  std::vector<std::string>  tmp317;
  tmp317.push_back("CATALOGSERVER");

  tmp316.contexts = tmp317;
  tmp316.__isset.contexts = true;
  tmp316.description = "Amount of time clients of Catalog Service spent waiting for service threads";
  tmp316.__isset.description = true;
  tmp316.key = "impala.thrift-server.CatalogService.svc-thread-wait-time";
  tmp316.__isset.key = true;
  tmp316.kind = ( ::impala::TMetricKind::type)5;
  tmp316.__isset.kind = true;
  tmp316.label = "Catalog Service clients' wait time for service threads";
  tmp316.__isset.label = true;
  tmp316.units = ( ::impala::TUnit::type)10;
  tmp316.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.CatalogService.svc-thread-wait-time", tmp316));
  TMetricDef tmp318;
  std::vector<std::string>  tmp319;
  tmp319.push_back("CATALOGSERVER");

  tmp318.contexts = tmp319;
  tmp318.__isset.contexts = true;
  tmp318.description = "The number of connection requests to the Catalog Service that have been timed out waiting to be setup.";
  tmp318.__isset.description = true;
  tmp318.key = "impala.thrift-server.CatalogService.timedout-cnxn-requests";
  tmp318.__isset.key = true;
  tmp318.kind = ( ::impala::TMetricKind::type)0;
  tmp318.__isset.kind = true;
  tmp318.label = "Catalog Service Connection Requests Timed Out";
  tmp318.__isset.label = true;
  tmp318.units = ( ::impala::TUnit::type)7;
  tmp318.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.CatalogService.timedout-cnxn-requests", tmp318));
  TMetricDef tmp320;
  std::vector<std::string>  tmp321;
  tmp321.push_back("CATALOGSERVER");

  tmp320.contexts = tmp321;
  tmp320.__isset.contexts = true;
  tmp320.description = "The total number of connections made to this Catalog Server's catalog service  over its lifetime.";
  tmp320.__isset.description = true;
  tmp320.key = "impala.thrift-server.CatalogService.total-connections";
  tmp320.__isset.key = true;
  tmp320.kind = ( ::impala::TMetricKind::type)1;
  tmp320.__isset.kind = true;
  tmp320.label = "Catalog Service Total Connections";
  tmp320.__isset.label = true;
  tmp320.units = ( ::impala::TUnit::type)0;
  tmp320.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.CatalogService.total-connections", tmp320));
  TMetricDef tmp322;
  std::vector<std::string>  tmp323;
  tmp323.push_back("IMPALAD");

  tmp322.contexts = tmp323;
  tmp322.__isset.contexts = true;
  tmp322.description = "The number of connections to the Statestore Service that have been accepted and are waiting to be setup.";
  tmp322.__isset.description = true;
  tmp322.key = "impala.thrift-server.StatestoreService.connection-setup-queue-size";
  tmp322.__isset.key = true;
  tmp322.kind = ( ::impala::TMetricKind::type)0;
  tmp322.__isset.kind = true;
  tmp322.label = "Statestore Service Connections Queued for Setup";
  tmp322.__isset.label = true;
  tmp322.units = ( ::impala::TUnit::type)7;
  tmp322.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.StatestoreService.connection-setup-queue-size", tmp322));
  TMetricDef tmp324;
  std::vector<std::string>  tmp325;
  tmp325.push_back("STATESTORE");

  tmp324.contexts = tmp325;
  tmp324.__isset.contexts = true;
  tmp324.description = "Amount of time clients of StateStore Service spent waiting for connection to be set up";
  tmp324.__isset.description = true;
  tmp324.key = "impala.thrift-server.StatestoreService.connection-setup-time";
  tmp324.__isset.key = true;
  tmp324.kind = ( ::impala::TMetricKind::type)5;
  tmp324.__isset.kind = true;
  tmp324.label = "StateStore Service client connection setup time";
  tmp324.__isset.label = true;
  tmp324.units = ( ::impala::TUnit::type)10;
  tmp324.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.StatestoreService.connection-setup-time", tmp324));
  TMetricDef tmp326;
  ...
  tmp326.description = "The number of active connections to this StateStore's service.";
  tmp326.__isset.description = true;
  tmp326.key = "impala.thrift-server.StatestoreService.connections-in-use";
  tmp326.__isset.key = true;
  tmp326.kind = ( ::impala::TMetricKind::type)0;
  tmp326.__isset.kind = true;
  tmp326.label = "StateStore Service Active Connections";
  tmp326.__isset.label = true;
  tmp326.units = ( ::impala::TUnit::type)7;
  tmp326.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.StatestoreService.connections-in-use", tmp326));
  TMetricDef tmp328;
  std::vector<std::string>  tmp329;
  tmp329.push_back("STATESTORE");

  tmp328.contexts = tmp329;
  tmp328.__isset.contexts = true;
  tmp328.description = "Amount of time clients of StateStore Service spent waiting for service threads";
  tmp328.__isset.description = true;
  tmp328.key = "impala.thrift-server.StatestoreService.svc-thread-wait-time";
  tmp328.__isset.key = true;
  tmp328.kind = ( ::impala::TMetricKind::type)5;
  tmp328.__isset.kind = true;
  tmp328.label = "StateStore Service clients' wait time for service threads";
  tmp328.__isset.label = true;
  tmp328.units = ( ::impala::TUnit::type)10;
  tmp328.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.StatestoreService.svc-thread-wait-time", tmp328));
  TMetricDef tmp330;
  ...
  tmp330.description = "The number of connection requests to the Statestore Service that have been timed out waiting to be setup.";
  tmp330.__isset.description = true;
  tmp330.key = "impala.thrift-server.StatestoreService.timedout-cnxn-requests";
  tmp330.__isset.key = true;
  tmp330.kind = ( ::impala::TMetricKind::type)0;
  tmp330.__isset.kind = true;
  tmp330.label = "Statestore Service Connection Requests Timed Out";
  tmp330.__isset.label = true;
  tmp330.units = ( ::impala::TUnit::type)7;
  tmp330.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.StatestoreService.timedout-cnxn-requests", tmp330));
  TMetricDef tmp332;
  std::vector<std::string>  tmp333;
  tmp333.push_back("STATESTORE");

  tmp332.contexts = tmp333;
  tmp332.__isset.contexts = true;
  tmp332.description = "The total number of connections made to this StateStore's StateStore service over its lifetime.";
  tmp332.__isset.description = true;
  tmp332.key = "impala.thrift-server.StatestoreService.total-connections";
  tmp332.__isset.key = true;
  tmp332.kind = ( ::impala::TMetricKind::type)1;
  tmp332.__isset.kind = true;
  tmp332.label = "StateStore Service Connections";
  tmp332.__isset.label = true;
  tmp332.units = ( ::impala::TUnit::type)0;
  tmp332.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.StatestoreService.total-connections", tmp332));
  TMetricDef tmp334;
  ...
  tmp334.description = "The number of connections to the Impala Backend Server that have been accepted and are waiting to be setup.";
  tmp334.__isset.description = true;
  tmp334.key = "impala.thrift-server.backend.connection-setup-queue-size";
  tmp334.__isset.key = true;
  tmp334.kind = ( ::impala::TMetricKind::type)0;
  tmp334.__isset.kind = true;
  tmp334.label = "Impala Backend Server Connections Queued for Setup";
  tmp334.__isset.label = true;
  tmp334.units = ( ::impala::TUnit::type)7;
  tmp334.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.backend.connection-setup-queue-size", tmp334));
  TMetricDef tmp336;
  ...
  tmp336.description = "Amount of time clients of Impala Backend Server spent waiting for connection to be set up";
  tmp336.__isset.description = true;
  tmp336.key = "impala.thrift-server.backend.connection-setup-time";
  tmp336.__isset.key = true;
  tmp336.kind = ( ::impala::TMetricKind::type)5;
  tmp336.__isset.kind = true;
  tmp336.label = "Impala Backend client connections setup time";
  tmp336.__isset.label = true;
  tmp336.units = ( ::impala::TUnit::type)10;
  tmp336.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.backend.connection-setup-time", tmp336));
  TMetricDef tmp338;
  ...
  tmp338.description = "The number of active Impala Backend client connections to this Impala Daemon.";
  tmp338.__isset.description = true;
  tmp338.key = "impala.thrift-server.backend.connections-in-use";
  tmp338.__isset.key = true;
  tmp338.kind = ( ::impala::TMetricKind::type)0;
  tmp338.__isset.kind = true;
  tmp338.label = "Impala Backend Server Active Connections";
  tmp338.__isset.label = true;
  tmp338.units = ( ::impala::TUnit::type)7;
  tmp338.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.backend.connections-in-use", tmp338));
  TMetricDef tmp340;
  ...
  tmp340.description = "Amount of time clients of Impala Backend Server spent waiting for service threads";
  tmp340.__isset.description = true;
  tmp340.key = "impala.thrift-server.backend.svc-thread-wait-time";
  tmp340.__isset.key = true;
  tmp340.kind = ( ::impala::TMetricKind::type)5;
  tmp340.__isset.kind = true;
  tmp340.label = "Impala Backend Server clients' wait time for service threads";
  tmp340.__isset.label = true;
  tmp340.units = ( ::impala::TUnit::type)10;
  tmp340.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.backend.svc-thread-wait-time", tmp340));
  TMetricDef tmp342;
  ...
  tmp342.description = "The number of connection requests to the Impala Backend Server that have been timed out waiting to be setup.";
  tmp342.__isset.description = true;
  tmp342.key = "impala.thrift-server.backend.timedout-cnxn-requests";
  tmp342.__isset.key = true;
  tmp342.kind = ( ::impala::TMetricKind::type)0;
  tmp342.__isset.kind = true;
  tmp342.label = "Impala Backend Server Connection Requests Timed Out";
  tmp342.__isset.label = true;
  tmp342.units = ( ::impala::TUnit::type)7;
  tmp342.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.backend.timedout-cnxn-requests", tmp342));
  TMetricDef tmp344;
  ...
  tmp344.description = "The total number of Impala Backend client connections made to this Impala Daemon over its lifetime.";
  tmp344.__isset.description = true;
  tmp344.key = "impala.thrift-server.backend.total-connections";
  tmp344.__isset.key = true;
  tmp344.kind = ( ::impala::TMetricKind::type)1;
  tmp344.__isset.kind = true;
  tmp344.label = "Impala Backend Server Connections";
  tmp344.__isset.label = true;
  tmp344.units = ( ::impala::TUnit::type)0;
  tmp344.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.backend.total-connections", tmp344));
  TMetricDef tmp346;
  ...
  tmp346.description = "The number of Beeswax API connections to this Impala Daemon that have been accepted and are waiting to be setup.";
  tmp346.__isset.description = true;
  tmp346.key = "impala.thrift-server.beeswax-frontend.connection-setup-queue-size";
  tmp346.__isset.key = true;
  tmp346.kind = ( ::impala::TMetricKind::type)0;
  tmp346.__isset.kind = true;
  tmp346.label = "Beeswax API Connections Queued for Setup";
  tmp346.__isset.label = true;
  tmp346.units = ( ::impala::TUnit::type)7;
  tmp346.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.beeswax-frontend.connection-setup-queue-size", tmp346));
  TMetricDef tmp348;
  ...
  tmp348.description = "Amount of time clients of Beeswax API spent waiting for connection to be set up";
  tmp348.__isset.description = true;
  tmp348.key = "impala.thrift-server.beeswax-frontend.connection-setup-time";
  tmp348.__isset.key = true;
  tmp348.kind = ( ::impala::TMetricKind::type)5;
  tmp348.__isset.kind = true;
  tmp348.label = "Beeswax API client connection setup time";
  tmp348.__isset.label = true;
  tmp348.units = ( ::impala::TUnit::type)10;
  tmp348.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.beeswax-frontend.connection-setup-time", tmp348));
  TMetricDef tmp350;
  ...
  tmp350.description = "The number of active Beeswax API connections to this Impala Daemon.";
  tmp350.__isset.description = true;
  tmp350.key = "impala.thrift-server.beeswax-frontend.connections-in-use";
  tmp350.__isset.key = true;
  tmp350.kind = ( ::impala::TMetricKind::type)0;
  tmp350.__isset.kind = true;
  tmp350.label = "Beeswax API Active Connections";
  tmp350.__isset.label = true;
  tmp350.units = ( ::impala::TUnit::type)7;
  tmp350.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.beeswax-frontend.connections-in-use", tmp350));
  TMetricDef tmp352;
  ...
  tmp352.description = "Amount of time clients of Beeswax API spent waiting for service threads";
  tmp352.__isset.description = true;
  tmp352.key = "impala.thrift-server.beeswax-frontend.svc-thread-wait-time";
  tmp352.__isset.key = true;
  tmp352.kind = ( ::impala::TMetricKind::type)5;
  tmp352.__isset.kind = true;
  tmp352.label = "Beeswax API clients' wait time for service threads";
  tmp352.__isset.label = true;
  tmp352.units = ( ::impala::TUnit::type)10;
  tmp352.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.beeswax-frontend.svc-thread-wait-time", tmp352));
  TMetricDef tmp354;
  ...
  tmp354.description = "The number of Beeswax API connection requests to this Impala Daemon that have been timed out waiting to be setup.";
  tmp354.__isset.description = true;
  tmp354.key = "impala.thrift-server.beeswax-frontend.timedout-cnxn-requests";
  tmp354.__isset.key = true;
  tmp354.kind = ( ::impala::TMetricKind::type)0;
  tmp354.__isset.kind = true;
  tmp354.label = "Beeswax API Connection Requests Timed Out";
  tmp354.__isset.label = true;
  tmp354.units = ( ::impala::TUnit::type)7;
  tmp354.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.beeswax-frontend.timedout-cnxn-requests", tmp354));
  TMetricDef tmp356;
  ...
  tmp356.description = "The total number of Beeswax API connections made to this Impala Daemon over its lifetime.";
  tmp356.__isset.description = true;
  tmp356.key = "impala.thrift-server.beeswax-frontend.total-connections";
  tmp356.__isset.key = true;
  tmp356.kind = ( ::impala::TMetricKind::type)1;
  tmp356.__isset.kind = true;
  tmp356.label = "Beeswax API Total Connections";
  tmp356.__isset.label = true;
  tmp356.units = ( ::impala::TUnit::type)0;
  tmp356.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.beeswax-frontend.total-connections", tmp356));
  TMetricDef tmp358;
  ...
  tmp358.description = "The number of External Frontend API connections to this Impala Daemon that have been accepted and are waiting to be setup.";
  tmp358.__isset.description = true;
  tmp358.key = "impala.thrift-server.external-frontend.connection-setup-queue-size";
  tmp358.__isset.key = true;
  tmp358.kind = ( ::impala::TMetricKind::type)0;
  tmp358.__isset.kind = true;
  tmp358.label = "External Frontend API Connections Queued for Setup";
  tmp358.__isset.label = true;
  tmp358.units = ( ::impala::TUnit::type)7;
  tmp358.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.external-frontend.connection-setup-queue-size", tmp358));
  TMetricDef tmp360;
  ...
  tmp360.description = "Amount of time clients of External Frontend API spent waiting for connection to be set up";
  tmp360.__isset.description = true;
  tmp360.key = "impala.thrift-server.external-frontend.connection-setup-time";
  tmp360.__isset.key = true;
  tmp360.kind = ( ::impala::TMetricKind::type)5;
  tmp360.__isset.kind = true;
  tmp360.label = "External Frontend API client connection setup time";
  tmp360.__isset.label = true;
  tmp360.units = ( ::impala::TUnit::type)10;
  tmp360.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.external-frontend.connection-setup-time", tmp360));
  TMetricDef tmp362;
  ...
  tmp362.description = "The number of active External Frontend API connections to this Impala Daemon.";
  tmp362.__isset.description = true;
  tmp362.key = "impala.thrift-server.external-frontend.connections-in-use";
  tmp362.__isset.key = true;
  tmp362.kind = ( ::impala::TMetricKind::type)0;
  tmp362.__isset.kind = true;
  tmp362.label = "External Frontend API Active Connections";
  tmp362.__isset.label = true;
  tmp362.units = ( ::impala::TUnit::type)7;
  tmp362.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.external-frontend.connections-in-use", tmp362));
  TMetricDef tmp364;
  ...
  tmp364.description = "Amount of time clients of External Frontend API spent waiting for service threads";
  tmp364.__isset.description = true;
  tmp364.key = "impala.thrift-server.external-frontend.svc-thread-wait-time";
  tmp364.__isset.key = true;
  tmp364.kind = ( ::impala::TMetricKind::type)5;
  tmp364.__isset.kind = true;
  tmp364.label = "External Frontend API clients' wait time for service threads";
  tmp364.__isset.label = true;
  tmp364.units = ( ::impala::TUnit::type)10;
  tmp364.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.external-frontend.svc-thread-wait-time", tmp364));
  TMetricDef tmp366;
  ...
  tmp366.description = "The number of External Frontend API connection requests to this Impala Daemon that have been timed out waiting to be setup.";
  tmp366.__isset.description = true;
  tmp366.key = "impala.thrift-server.external-frontend.timedout-cnxn-requests";
  tmp366.__isset.key = true;
  tmp366.kind = ( ::impala::TMetricKind::type)0;
  tmp366.__isset.kind = true;
  tmp366.label = "External Frontend API Connection Requests Timed Out";
  tmp366.__isset.label = true;
  tmp366.units = ( ::impala::TUnit::type)7;
  tmp366.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.external-frontend.timedout-cnxn-requests", tmp366));
  TMetricDef tmp368;
  ...
  tmp368.description = "The total number of External Frontend API connections made to this Impala Daemon over its lifetime.";
  tmp368.__isset.description = true;
  tmp368.key = "impala.thrift-server.external-frontend.total-connections";
  tmp368.__isset.key = true;
  tmp368.kind = ( ::impala::TMetricKind::type)1;
  tmp368.__isset.kind = true;
  tmp368.label = "External Frontend API Total Connections";
  tmp368.__isset.label = true;
  tmp368.units = ( ::impala::TUnit::type)0;
  tmp368.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.external-frontend.total-connections", tmp368));
  TMetricDef tmp370;
  ...
  tmp370.description = "The number of HiveServer2 API connections to this Impala Daemon that have been accepted and are waiting to be setup.";
  tmp370.__isset.description = true;
  tmp370.key = "impala.thrift-server.hiveserver2-frontend.connection-setup-queue-size";
  tmp370.__isset.key = true;
  tmp370.kind = ( ::impala::TMetricKind::type)0;
  tmp370.__isset.kind = true;
  tmp370.label = "HiveServer2 API Connections Queued for Setup";
  tmp370.__isset.label = true;
  tmp370.units = ( ::impala::TUnit::type)7;
  tmp370.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-frontend.connection-setup-queue-size", tmp370));
  TMetricDef tmp372;
  ...
  tmp372.description = "Amount of time clients of HiveServer2 API spent waiting for connection to be set up";
  tmp372.__isset.description = true;
  tmp372.key = "impala.thrift-server.hiveserver2-frontend.connection-setup-time";
  tmp372.__isset.key = true;
  tmp372.kind = ( ::impala::TMetricKind::type)5;
  tmp372.__isset.kind = true;
  tmp372.label = "HiveServer2 API client connection setup time";
  tmp372.__isset.label = true;
  tmp372.units = ( ::impala::TUnit::type)10;
  tmp372.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-frontend.connection-setup-time", tmp372));
  TMetricDef tmp374;
  ...
  tmp374.description = "The number of active HiveServer2 API connections to this Impala Daemon.";
  tmp374.__isset.description = true;
  tmp374.key = "impala.thrift-server.hiveserver2-frontend.connections-in-use";
  tmp374.__isset.key = true;
  tmp374.kind = ( ::impala::TMetricKind::type)0;
  tmp374.__isset.kind = true;
  tmp374.label = "HiveServer2 API Active Connections";
  tmp374.__isset.label = true;
  tmp374.units = ( ::impala::TUnit::type)7;
  tmp374.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-frontend.connections-in-use", tmp374));
  TMetricDef tmp376;
  ...
  tmp376.description = "Amount of time clients of HiveServer2 API spent waiting for service threads";
  tmp376.__isset.description = true;
  tmp376.key = "impala.thrift-server.hiveserver2-frontend.svc-thread-wait-time";
  tmp376.__isset.key = true;
  tmp376.kind = ( ::impala::TMetricKind::type)5;
  tmp376.__isset.kind = true;
  tmp376.label = "HiveServer2 API clients' wait time for service threads";
  tmp376.__isset.label = true;
  tmp376.units = ( ::impala::TUnit::type)10;
  tmp376.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-frontend.svc-thread-wait-time", tmp376));
  TMetricDef tmp378;
  ...
  tmp378.description = "The number of HiveServer2 API connection requests to this Impala Daemon that have been timed out waiting to be setup.";
  tmp378.__isset.description = true;
  tmp378.key = "impala.thrift-server.hiveserver2-frontend.timedout-cnxn-requests";
  tmp378.__isset.key = true;
  tmp378.kind = ( ::impala::TMetricKind::type)0;
  tmp378.__isset.kind = true;
  tmp378.label = "HiveServer2 API Connection Requests Timed Out";
  tmp378.__isset.label = true;
  tmp378.units = ( ::impala::TUnit::type)7;
  tmp378.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-frontend.timedout-cnxn-requests", tmp378));
  TMetricDef tmp380;
  ...
  tmp380.description = "The total number of HiveServer2 API connections made to this Impala Daemon over its lifetime.";
  tmp380.__isset.description = true;
  tmp380.key = "impala.thrift-server.hiveserver2-frontend.total-connections";
  tmp380.__isset.key = true;
  tmp380.kind = ( ::impala::TMetricKind::type)1;
  tmp380.__isset.kind = true;
  tmp380.label = "HiveServer2 API Total Connections";
  tmp380.__isset.label = true;
  tmp380.units = ( ::impala::TUnit::type)0;
  tmp380.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-frontend.total-connections", tmp380));
  TMetricDef tmp382;
  ...
  tmp382.description = "The number of HiveServer2 HTTP API connections to this Impala Daemon that have been accepted and are waiting to be setup.";
  tmp382.__isset.description = true;
  tmp382.key = "impala.thrift-server.hiveserver2-http-frontend.connection-setup-queue-size";
  tmp382.__isset.key = true;
  tmp382.kind = ( ::impala::TMetricKind::type)0;
  tmp382.__isset.kind = true;
  tmp382.label = "HiveServer2 HTTP API Connections Queued for Setup";
  tmp382.__isset.label = true;
  tmp382.units = ( ::impala::TUnit::type)7;
  tmp382.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.connection-setup-queue-size", tmp382));
  TMetricDef tmp384;
  ...
  tmp384.description = "Amount of time clients of HiveServer2 HTTP API spent waiting for connection to be set up";
  tmp384.__isset.description = true;
  tmp384.key = "impala.thrift-server.hiveserver2-http-frontend.connection-setup-time";
  tmp384.__isset.key = true;
  tmp384.kind = ( ::impala::TMetricKind::type)5;
  tmp384.__isset.kind = true;
  tmp384.label = "HiveServer2 HTTP API client connection setup time";
  tmp384.__isset.label = true;
  tmp384.units = ( ::impala::TUnit::type)10;
  tmp384.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.connection-setup-time", tmp384));
  TMetricDef tmp386;
  ...
  tmp386.description = "The number of active HiveServer2 HTTP API connections to this Impala Daemon.";
  tmp386.__isset.description = true;
  tmp386.key = "impala.thrift-server.hiveserver2-http-frontend.connections-in-use";
  tmp386.__isset.key = true;
  tmp386.kind = ( ::impala::TMetricKind::type)0;
  tmp386.__isset.kind = true;
  tmp386.label = "HiveServer2 HTTP API Active Connections";
  tmp386.__isset.label = true;
  tmp386.units = ( ::impala::TUnit::type)7;
  tmp386.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.connections-in-use", tmp386));
  TMetricDef tmp388;
  ...
  tmp388.description = "Amount of time clients of HiveServer2 HTTP API spent waiting for service threads";
  tmp388.__isset.description = true;
  tmp388.key = "impala.thrift-server.hiveserver2-http-frontend.svc-thread-wait-time";
  tmp388.__isset.key = true;
  tmp388.kind = ( ::impala::TMetricKind::type)5;
  tmp388.__isset.kind = true;
  tmp388.label = "HiveServer2 HTTP API clients' wait time for service threads";
  tmp388.__isset.label = true;
  tmp388.units = ( ::impala::TUnit::type)10;
  tmp388.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.svc-thread-wait-time", tmp388));
  TMetricDef tmp390;
  ...
  tmp390.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that have been timed out waiting to be setup.";
  tmp390.__isset.description = true;
  tmp390.key = "impala.thrift-server.hiveserver2-http-frontend.timedout-cnxn-requests";
  tmp390.__isset.key = true;
  tmp390.kind = ( ::impala::TMetricKind::type)0;
  tmp390.__isset.kind = true;
  tmp390.label = "HiveServer2 HTTP API Connection Requests Timed Out";
  tmp390.__isset.label = true;
  tmp390.units = ( ::impala::TUnit::type)7;
  tmp390.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.timedout-cnxn-requests", tmp390));
  TMetricDef tmp392;
  ...
  tmp392.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that failed to authenticate with Basic auth due to an invalid username or password.";
  tmp392.__isset.description = true;
  tmp392.key = "impala.thrift-server.hiveserver2-http-frontend.total-basic-auth-failure";
  tmp392.__isset.key = true;
  tmp392.kind = ( ::impala::TMetricKind::type)1;
  tmp392.__isset.kind = true;
  tmp392.label = "HiveServer2 HTTP API Connection Basic Auth Failure";
  tmp392.__isset.label = true;
  tmp392.units = ( ::impala::TUnit::type)7;
  tmp392.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-basic-auth-failure", tmp392));
  TMetricDef tmp394;
  ...
  tmp394.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that were successfully authenticated with Basic (username/password) auth.";
  tmp394.__isset.description = true;
  tmp394.key = "impala.thrift-server.hiveserver2-http-frontend.total-basic-auth-success";
  tmp394.__isset.key = true;
  tmp394.kind = ( ::impala::TMetricKind::type)1;
  tmp394.__isset.kind = true;
  tmp394.label = "HiveServer2 HTTP API Connection Basic Auth Success";
  tmp394.__isset.label = true;
  tmp394.units = ( ::impala::TUnit::type)7;
  tmp394.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-basic-auth-success", tmp394));
  TMetricDef tmp396;
  ...
  tmp396.description = "The total number of HiveServer2 HTTP API connections made to this Impala Daemon over its lifetime.";
  tmp396.__isset.description = true;
  tmp396.key = "impala.thrift-server.hiveserver2-http-frontend.total-connections";
  tmp396.__isset.key = true;
  tmp396.kind = ( ::impala::TMetricKind::type)1;
  tmp396.__isset.kind = true;
  tmp396.label = "HiveServer2 HTTP API Total Connections";
  tmp396.__isset.label = true;
  tmp396.units = ( ::impala::TUnit::type)0;
  tmp396.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-connections", tmp396));
  TMetricDef tmp398;
  ...
  tmp398.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that provided an invalid cookie.";
  tmp398.__isset.description = true;
  tmp398.key = "impala.thrift-server.hiveserver2-http-frontend.total-cookie-auth-failure";
  tmp398.__isset.key = true;
  tmp398.kind = ( ::impala::TMetricKind::type)1;
  tmp398.__isset.kind = true;
  tmp398.label = "HiveServer2 HTTP API Connection Cookie Auth Failure";
  tmp398.__isset.label = true;
  tmp398.units = ( ::impala::TUnit::type)7;
  tmp398.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-cookie-auth-failure", tmp398));
  TMetricDef tmp400;
  ...
  tmp400.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that were successfully authenticated using a cookie.";
  tmp400.__isset.description = true;
  tmp400.key = "impala.thrift-server.hiveserver2-http-frontend.total-cookie-auth-success";
  tmp400.__isset.key = true;
  tmp400.kind = ( ::impala::TMetricKind::type)1;
  tmp400.__isset.kind = true;
  tmp400.label = "HiveServer2 HTTP API Connection Cookie Auth Success";
  tmp400.__isset.label = true;
  tmp400.units = ( ::impala::TUnit::type)7;
  tmp400.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-cookie-auth-success", tmp400));
  TMetricDef tmp402;
  ...
  tmp402.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that were attempted to authenticate using JWT Token but were unsuccessful.";
  tmp402.__isset.description = true;
  tmp402.key = "impala.thrift-server.hiveserver2-http-frontend.total-jwt-token-auth-failure";
  tmp402.__isset.key = true;
  tmp402.kind = ( ::impala::TMetricKind::type)1;
  tmp402.__isset.kind = true;
  tmp402.label = "HiveServer2 HTTP API Connection JWT Token Failure";
  tmp402.__isset.label = true;
  tmp402.units = ( ::impala::TUnit::type)7;
  tmp402.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-jwt-token-auth-failure", tmp402));
  TMetricDef tmp404;
  ...
  tmp404.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that were successfully authenticated using JWT Token.";
  tmp404.__isset.description = true;
  tmp404.key = "impala.thrift-server.hiveserver2-http-frontend.total-jwt-token-auth-success";
  tmp404.__isset.key = true;
  tmp404.kind = ( ::impala::TMetricKind::type)1;
  tmp404.__isset.kind = true;
  tmp404.label = "HiveServer2 HTTP API Connection JWT Token Success";
  tmp404.__isset.label = true;
  tmp404.units = ( ::impala::TUnit::type)7;
  tmp404.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-jwt-token-auth-success", tmp404));
  TMetricDef tmp406;
  ...
  tmp406.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that attempted to authenticate with Kerberos but were unsuccessful.";
  tmp406.__isset.description = true;
  tmp406.key = "impala.thrift-server.hiveserver2-http-frontend.total-negotiate-auth-failure";
  tmp406.__isset.key = true;
  tmp406.kind = ( ::impala::TMetricKind::type)1;
  tmp406.__isset.kind = true;
  tmp406.label = "HiveServer2 HTTP API Connection Kerberos Auth Failure";
  tmp406.__isset.label = true;
  tmp406.units = ( ::impala::TUnit::type)7;
  tmp406.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-negotiate-auth-failure", tmp406));
  TMetricDef tmp408;
  ...
  tmp408.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that were successfully authenticated with Kerberos";
  tmp408.__isset.description = true;
  tmp408.key = "impala.thrift-server.hiveserver2-http-frontend.total-negotiate-auth-success";
  tmp408.__isset.key = true;
  tmp408.kind = ( ::impala::TMetricKind::type)1;
  tmp408.__isset.kind = true;
  tmp408.label = "HiveServer2 HTTP API Connection Kerberos Auth Success";
  tmp408.__isset.label = true;
  tmp408.units = ( ::impala::TUnit::type)7;
  tmp408.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-negotiate-auth-success", tmp408));
  TMetricDef tmp410;
  ...
  tmp410.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that were attempted to authenticate using SAML but were unsuccessful.";
  tmp410.__isset.description = true;
  tmp410.key = "impala.thrift-server.hiveserver2-http-frontend.total-saml-auth-failure";
  tmp410.__isset.key = true;
  tmp410.kind = ( ::impala::TMetricKind::type)1;
  tmp410.__isset.kind = true;
  tmp410.label = "HiveServer2 HTTP API Connection SAML Failure";
  tmp410.__isset.label = true;
  tmp410.units = ( ::impala::TUnit::type)7;
  tmp410.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-saml-auth-failure", tmp410));
  TMetricDef tmp412;
  ...
  tmp412.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that were successfully authenticated using SAML.";
  tmp412.__isset.description = true;
  tmp412.key = "impala.thrift-server.hiveserver2-http-frontend.total-saml-auth-success";
  tmp412.__isset.key = true;
  tmp412.kind = ( ::impala::TMetricKind::type)1;
  tmp412.__isset.kind = true;
  tmp412.label = "HiveServer2 HTTP API Connection SAML Success";
  tmp412.__isset.label = true;
  tmp412.units = ( ::impala::TUnit::type)7;
  tmp412.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-saml-auth-success", tmp412));
  TMetricDef tmp414;
  ...
  tmp414.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that skipped authentication as they have a trusted auth header.";
  tmp414.__isset.description = true;
  tmp414.key = "impala.thrift-server.hiveserver2-http-frontend.total-trusted-auth-header-check-success";
  tmp414.__isset.key = true;
  tmp414.kind = ( ::impala::TMetricKind::type)1;
  tmp414.__isset.kind = true;
  tmp414.label = "HiveServer2 HTTP API Connection Trusted Auth Header Check Success";
  tmp414.__isset.label = true;
  tmp414.units = ( ::impala::TUnit::type)7;
  tmp414.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-trusted-auth-header-check-success", tmp414));
  TMetricDef tmp416;
  ...
  tmp416.description = "The number of HiveServer2 HTTP API connection requests to this Impala Daemon that skipped authentication as they originated from a trusted domain.";
  tmp416.__isset.description = true;
  tmp416.key = "impala.thrift-server.hiveserver2-http-frontend.total-trusted-domain-check-success";
  tmp416.__isset.key = true;
  tmp416.kind = ( ::impala::TMetricKind::type)1;
  tmp416.__isset.kind = true;
  tmp416.label = "HiveServer2 HTTP API Connection Trusted Domain Check Success";
  tmp416.__isset.label = true;
  tmp416.units = ( ::impala::TUnit::type)7;
  tmp416.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.thrift-server.hiveserver2-http-frontend.total-trusted-domain-check-success", tmp416));
  TMetricDef tmp418;
  ...
  tmp418.description = "The number of HTTP connection requests to this daemon's webserver that attempted to authenticate with LDAP but were unsuccessful.";
  tmp418.__isset.description = true;
  tmp418.key = "impala.webserver.total-basic-auth-failure";
  tmp418.__isset.key = true;
  tmp418.kind = ( ::impala::TMetricKind::type)1;
  tmp418.__isset.kind = true;
  tmp418.label = "Webserver HTTP Connection LDAP Auth Failure";
  tmp418.__isset.label = true;
  tmp418.units = ( ::impala::TUnit::type)7;
  tmp418.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-basic-auth-failure", tmp418));
  TMetricDef tmp420;
  ...
  tmp420.description = "The number of HTTP connection requests to this daemon's webserver that were successfully authenticated with LDAP";
  tmp420.__isset.description = true;
  tmp420.key = "impala.webserver.total-basic-auth-success";
  tmp420.__isset.key = true;
  tmp420.kind = ( ::impala::TMetricKind::type)1;
  tmp420.__isset.kind = true;
  tmp420.label = "Webserver HTTP Connection LDAP Auth Success";
  tmp420.__isset.label = true;
  tmp420.units = ( ::impala::TUnit::type)7;
  tmp420.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-basic-auth-success", tmp420));
  TMetricDef tmp422;
  ...
  tmp422.description = "The number of HTTP connection requests to this daemon's webserver that provided an invalid cookie.";
  tmp422.__isset.description = true;
  tmp422.key = "impala.webserver.total-cookie-auth-failure";
  tmp422.__isset.key = true;
  tmp422.kind = ( ::impala::TMetricKind::type)1;
  tmp422.__isset.kind = true;
  tmp422.label = "Webserver HTTP Connection Cookie Auth Failure";
  tmp422.__isset.label = true;
  tmp422.units = ( ::impala::TUnit::type)7;
  tmp422.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-cookie-auth-failure", tmp422));
  TMetricDef tmp424;
  ...
  tmp424.description = "The number of HTTP connection requests to this daemon's webserver that were successfully authenticated using a cookie.";
  tmp424.__isset.description = true;
  tmp424.key = "impala.webserver.total-cookie-auth-success";
  tmp424.__isset.key = true;
  tmp424.kind = ( ::impala::TMetricKind::type)1;
  tmp424.__isset.kind = true;
  tmp424.label = "Webserver HTTP Connection Cookie Auth Success";
  tmp424.__isset.label = true;
  tmp424.units = ( ::impala::TUnit::type)7;
  tmp424.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-cookie-auth-success", tmp424));
  TMetricDef tmp426;
  ...
  tmp426.description = "The number of HTTP connection requests to this daemon's webserver that provided an invalid JWT token.";
  tmp426.__isset.description = true;
  tmp426.key = "impala.webserver.total-jwt-token-auth-failure";
  tmp426.__isset.key = true;
  tmp426.kind = ( ::impala::TMetricKind::type)1;
  tmp426.__isset.kind = true;
  tmp426.label = "Webserver HTTP Connection JWT Token Auth Failure";
  tmp426.__isset.label = true;
  tmp426.units = ( ::impala::TUnit::type)7;
  tmp426.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-jwt-token-auth-failure", tmp426));
  TMetricDef tmp428;
  ...
  tmp428.description = "The number of HTTP connection requests to this daemon's webserver that were successfully authenticated using a JWT token.";
  tmp428.__isset.description = true;
  tmp428.key = "impala.webserver.total-jwt-token-auth-success";
  tmp428.__isset.key = true;
  tmp428.kind = ( ::impala::TMetricKind::type)1;
  tmp428.__isset.kind = true;
  tmp428.label = "Webserver HTTP Connection JWT Token Auth Success";
  tmp428.__isset.label = true;
  tmp428.units = ( ::impala::TUnit::type)7;
  tmp428.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-jwt-token-auth-success", tmp428));
  TMetricDef tmp430;
  ...
  tmp430.description = "The number of HTTP connection requests to this daemon's webserver that attempted to authenticate with Kerberos but were unsuccessful.";
  tmp430.__isset.description = true;
  tmp430.key = "impala.webserver.total-negotiate-auth-failure";
  tmp430.__isset.key = true;
  tmp430.kind = ( ::impala::TMetricKind::type)1;
  tmp430.__isset.kind = true;
  tmp430.label = "Webserver HTTP Connection Kerberos Auth Failure";
  tmp430.__isset.label = true;
  tmp430.units = ( ::impala::TUnit::type)7;
  tmp430.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-negotiate-auth-failure", tmp430));
  TMetricDef tmp432;
  std::vector<std::string>  tmp433;
  tmp433.push_back("IMPALAD");
  tmp433.push_back("CATALOGSERVER");
  tmp433.push_back("STATESTORE");

  tmp432.contexts = tmp433;
  tmp432.__isset.contexts = true;
  tmp432.description = "The number of HTTP connection requests to this daemon's webserver that were successfully authenticated with Kerberos";
  tmp432.__isset.description = true;
  tmp432.key = "impala.webserver.total-negotiate-auth-success";
  tmp432.__isset.key = true;
  tmp432.kind = ( ::impala::TMetricKind::type)1;
  tmp432.__isset.kind = true;
  tmp432.label = "Webserver HTTP Connection Kerberos Auth Success";
  tmp432.__isset.label = true;
  tmp432.units = ( ::impala::TUnit::type)7;
  tmp432.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-negotiate-auth-success", tmp432));
  TMetricDef tmp434;
  std::vector<std::string>  tmp435;
  tmp435.push_back("IMPALAD");
  tmp435.push_back("CATALOGSERVER");
  tmp435.push_back("STATESTORE");

  tmp434.contexts = tmp435;
  tmp434.__isset.contexts = true;
  tmp434.description = "The number of HTTP connection requests to this daemon's webserver that skipped authentication as they have a trusted auth header.";
  tmp434.__isset.description = true;
  tmp434.key = "impala.webserver.total-trusted-auth-header-check-success";
  tmp434.__isset.key = true;
  tmp434.kind = ( ::impala::TMetricKind::type)1;
  tmp434.__isset.kind = true;
  tmp434.label = "Webserver HTTP Connection Trusted Auth Header Check Success";
  tmp434.__isset.label = true;
  tmp434.units = ( ::impala::TUnit::type)7;
  tmp434.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-trusted-auth-header-check-success", tmp434));
  TMetricDef tmp436;
  std::vector<std::string>  tmp437;
  tmp437.push_back("IMPALAD");
  tmp437.push_back("CATALOGSERVER");
  tmp437.push_back("STATESTORE");

  tmp436.contexts = tmp437;
  tmp436.__isset.contexts = true;
  tmp436.description = "The number of HTTP connection requests to this daemon's webserver that originated from a trusted domain.";
  tmp436.__isset.description = true;
  tmp436.key = "impala.webserver.total-trusted-domain-check-success";
  tmp436.__isset.key = true;
  tmp436.kind = ( ::impala::TMetricKind::type)1;
  tmp436.__isset.kind = true;
  tmp436.label = "Webserver HTTP Connection Trusted Domain Check Success";
  tmp436.__isset.label = true;
  tmp436.units = ( ::impala::TUnit::type)7;
  tmp436.__isset.units = true;

  TMetricDefs.insert(std::make_pair("impala.webserver.total-trusted-domain-check-success", tmp436));
  TMetricDef tmp438;
  ...
  tmp446.description = "Jvm $0 Peak Committed Usage Bytes";
  tmp446.__isset.description = true;
  tmp446.key = "jvm.$0.peak-committed-usage-bytes";
  tmp446.__isset.key = true;
  tmp446.kind = ( ::impala::TMetricKind::type)0;
  tmp446.__isset.kind = true;
  tmp446.label = "Jvm $0 Peak Committed Usage Bytes";
  tmp446.__isset.label = true;
  tmp446.units = ( ::impala::TUnit::type)3;
  tmp446.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.$0.peak-committed-usage-bytes", tmp446));
  TMetricDef tmp448;
  ...
  tmp448.description = "Jvm $0 Peak Current Usage Bytes";
  tmp448.__isset.description = true;
  tmp448.key = "jvm.$0.peak-current-usage-bytes";
  tmp448.__isset.key = true;
  tmp448.kind = ( ::impala::TMetricKind::type)0;
  tmp448.__isset.kind = true;
  tmp448.label = "Jvm $0 Peak Current Usage Bytes";
  tmp448.__isset.label = true;
  tmp448.units = ( ::impala::TUnit::type)3;
  tmp448.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.$0.peak-current-usage-bytes", tmp448));
  TMetricDef tmp450;
  ...
  tmp450.description = "Jvm $0 Peak Init Usage Bytes";
  tmp450.__isset.description = true;
  tmp450.key = "jvm.$0.peak-init-usage-bytes";
  tmp450.__isset.key = true;
  tmp450.kind = ( ::impala::TMetricKind::type)0;
  tmp450.__isset.kind = true;
  tmp450.label = "Jvm $0 Peak Init Usage Bytes";
  tmp450.__isset.label = true;
  tmp450.units = ( ::impala::TUnit::type)3;
  tmp450.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.$0.peak-init-usage-bytes", tmp450));
  TMetricDef tmp452;
  ...
  tmp452.description = "Jvm $0 Peak Max Usage Bytes";
  tmp452.__isset.description = true;
  tmp452.key = "jvm.$0.peak-max-usage-bytes";
  tmp452.__isset.key = true;
  tmp452.kind = ( ::impala::TMetricKind::type)0;
  tmp452.__isset.kind = true;
  tmp452.label = "Jvm $0 Peak Max Usage Bytes";
  tmp452.__isset.label = true;
  tmp452.units = ( ::impala::TUnit::type)3;
  tmp452.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.$0.peak-max-usage-bytes", tmp452));
  TMetricDef tmp454;
  ...
  tmp454.description = "Jvm Garbage Collection Count";
  tmp454.__isset.description = true;
  tmp454.key = "jvm.gc_count";
  tmp454.__isset.key = true;
  tmp454.kind = ( ::impala::TMetricKind::type)1;
  tmp454.__isset.kind = true;
  tmp454.label = "Jvm Garbage Collection Count";
  tmp454.__isset.label = true;
  tmp454.units = ( ::impala::TUnit::type)0;
  tmp454.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.gc_count", tmp454));
  TMetricDef tmp456;
  ...
  tmp456.description = "Jvm Pause Detection Info Threshold Exceeded";
  tmp456.__isset.description = true;
  tmp456.key = "jvm.gc_num_info_threshold_exceeded";
  tmp456.__isset.key = true;
  tmp456.kind = ( ::impala::TMetricKind::type)1;
  tmp456.__isset.kind = true;
  tmp456.label = "Jvm Pause Detector Info Threshold Exceeded";
  tmp456.__isset.label = true;
  tmp456.units = ( ::impala::TUnit::type)0;
  tmp456.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.gc_num_info_threshold_exceeded", tmp456));
  TMetricDef tmp458;
  ...
  tmp458.description = "Jvm Pause Detection Warning Threshold Exceeded";
  tmp458.__isset.description = true;
  tmp458.key = "jvm.gc_num_warn_threshold_exceeded";
  tmp458.__isset.key = true;
  tmp458.kind = ( ::impala::TMetricKind::type)1;
  tmp458.__isset.kind = true;
  tmp458.label = "Jvm Pause Detector Warn Threshold Exceeded";
  tmp458.__isset.label = true;
  tmp458.units = ( ::impala::TUnit::type)0;
  tmp458.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.gc_num_warn_threshold_exceeded", tmp458));
  TMetricDef tmp460;
  std::vector<std::string>  tmp461;
  tmp461.push_back("CATALOGSERVER");
  tmp461.push_back("IMPALAD");

  tmp460.contexts = tmp461;
  tmp460.__isset.contexts = true;
  tmp460.description = "Jvm Garbage Collection Time";
  tmp460.__isset.description = true;
  tmp460.key = "jvm.gc_time_millis";
  tmp460.__isset.key = true;
  tmp460.kind = ( ::impala::TMetricKind::type)1;
  tmp460.__isset.kind = true;
  tmp460.label = "Jvm Garbage Collection Time";
  tmp460.__isset.label = true;
  tmp460.units = ( ::impala::TUnit::type)8;
  tmp460.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.gc_time_millis", tmp460));
  TMetricDef tmp462;
  std::vector<std::string>  tmp463;
  tmp463.push_back("CATALOGSERVER");
  tmp463.push_back("IMPALAD");

  tmp462.contexts = tmp463;
  tmp462.__isset.contexts = true;
  tmp462.description = "Jvm Pause Detection Extra Sleep Time";
  tmp462.__isset.description = true;
  tmp462.key = "jvm.gc_total_extra_sleep_time_millis";
  tmp462.__isset.key = true;
  tmp462.kind = ( ::impala::TMetricKind::type)1;
  tmp462.__isset.kind = true;
  tmp462.label = "Jvm Pause Detector Extra Sleep Time";
  tmp462.__isset.label = true;
  tmp462.units = ( ::impala::TUnit::type)8;
  tmp462.__isset.units = true;

  TMetricDefs.insert(std::make_pair("jvm.gc_total_extra_sleep_time_millis", tmp462));
  TMetricDef tmp464;
  std::vector<std::string>  tmp465;
  tmp465.push_back("IMPALAD");
  tmp465.push_back("CATALOGSERVER");
  tmp465.push_back("STATESTORE");

  tmp464.contexts = tmp465;
  tmp464.__isset.contexts = true;
  tmp464.description = "A version string identifying the Kudu client";
  tmp464.__isset.description = true;
  tmp464.key = "kudu-client.version";
  tmp464.__isset.key = true;
  tmp464.kind = ( ::impala::TMetricKind::type)2;
  tmp464.__isset.kind = true;
  tmp464.label = "Kudu Client Version";
  tmp464.__isset.label = true;
  tmp464.units = ( ::impala::TUnit::type)7;
  tmp464.__isset.units = true;

  TMetricDefs.insert(std::make_pair("kudu-client.version", tmp464));
  TMetricDef tmp466;
  ...
  tmp466.description = "Memtracker $0 Current Usage Bytes";
  tmp466.__isset.description = true;
  tmp466.key = "mem-tracker.$0.current_usage_bytes";
  tmp466.__isset.key = true;
  tmp466.kind = ( ::impala::TMetricKind::type)0;
  tmp466.__isset.kind = true;
  tmp466.label = "Memtracker $0 Current Usage Bytes";
  tmp466.__isset.label = true;
  tmp466.units = ( ::impala::TUnit::type)3;
  tmp466.__isset.units = true;

  TMetricDefs.insert(std::make_pair("mem-tracker.$0.current_usage_bytes", tmp466));
  TMetricDef tmp468;
  ...
  tmp468.description = "Memtracker $0 Peak Usage Bytes";
  tmp468.__isset.description = true;
  tmp468.key = "mem-tracker.$0.peak_usage_bytes";
  tmp468.__isset.key = true;
  tmp468.kind = ( ::impala::TMetricKind::type)0;
  tmp468.__isset.kind = true;
  tmp468.label = "Memtracker $0 Peak Max Bytes";
  tmp468.__isset.label = true;
  tmp468.units = ( ::impala::TUnit::type)3;
  tmp468.__isset.units = true;

  TMetricDefs.insert(std::make_pair("mem-tracker.$0.peak_usage_bytes", tmp468));
  TMetricDef tmp470;
  ...
  tmp470.description = "The amount of memory freed by the last memory tracker garbage collection.";
  tmp470.__isset.description = true;
  tmp470.key = "mem-tracker.process.bytes-freed-by-last-gc";
  tmp470.__isset.key = true;
  tmp470.kind = ( ::impala::TMetricKind::type)0;
  tmp470.__isset.kind = true;
  tmp470.label = "MemTracker Bytes Freed By Last Garbage Collection";
  tmp470.__isset.label = true;
  tmp470.units = ( ::impala::TUnit::type)3;
  tmp470.__isset.units = true;

  TMetricDefs.insert(std::make_pair("mem-tracker.process.bytes-freed-by-last-gc", tmp470));
  TMetricDef tmp472;
  ...
  tmp472.description = "The amount of memory by which the process was over its memory limit the last time the memory limit was encountered.";
  tmp472.__isset.description = true;
  tmp472.key = "mem-tracker.process.bytes-over-limit";
  tmp472.__isset.key = true;
  tmp472.kind = ( ::impala::TMetricKind::type)0;
  tmp472.__isset.kind = true;
  tmp472.label = "MemTracker Bytes Over Limit";
  tmp472.__isset.label = true;
  tmp472.units = ( ::impala::TUnit::type)3;
  tmp472.__isset.units = true;

  TMetricDefs.insert(std::make_pair("mem-tracker.process.bytes-over-limit", tmp472));
  TMetricDef tmp474;
  ...
  tmp476.description = "The total number of garbage collections performed by the memory tracker over the life of the process.";
  tmp476.__isset.description = true;
  tmp476.key = "mem-tracker.process.num-gcs";
  tmp476.__isset.key = true;
  tmp476.kind = ( ::impala::TMetricKind::type)1;
  tmp476.__isset.kind = true;
  tmp476.label = "MemTracker Garbage Collections";
  tmp476.__isset.label = true;
  tmp476.units = ( ::impala::TUnit::type)0;
  tmp476.__isset.units = true;

  TMetricDefs.insert(std::make_pair("mem-tracker.process.num-gcs", tmp476));
  TMetricDef tmp478;
  ...
  tmp478.description = "Total bytes of anonymous (a.k.a. transparent) huge pages used by this process.";
  tmp478.__isset.description = true;
  tmp478.key = "memory.anon-huge-page-bytes";
  tmp478.__isset.key = true;
  tmp478.kind = ( ::impala::TMetricKind::type)0;
  tmp478.__isset.kind = true;
  tmp478.label = "Anonymous Huge Pages.";
  tmp478.__isset.label = true;
  tmp478.units = ( ::impala::TUnit::type)3;
  tmp478.__isset.units = true;

  TMetricDefs.insert(std::make_pair("memory.anon-huge-page-bytes", tmp478));
  TMetricDef tmp480;
  ...
  tmp480.description = "Total bytes of memory mappings in this process (the virtual memory size).";
  tmp480.__isset.description = true;
  tmp480.key = "memory.mapped-bytes";
  tmp480.__isset.key = true;
  tmp480.kind = ( ::impala::TMetricKind::type)0;
  tmp480.__isset.kind = true;
  tmp480.label = "Total Virtual Memory.";
  tmp480.__isset.label = true;
  tmp480.units = ( ::impala::TUnit::type)3;
  tmp480.__isset.units = true;

  TMetricDefs.insert(std::make_pair("memory.mapped-bytes", tmp480));
  TMetricDef tmp482;
  ...
  tmp482.description = "Total number of memory mappings in this process.";
  tmp482.__isset.description = true;
  tmp482.key = "memory.num-maps";
  tmp482.__isset.key = true;
  tmp482.kind = ( ::impala::TMetricKind::type)0;
  tmp482.__isset.kind = true;
  tmp482.label = "Number of memory mappings.";
  tmp482.__isset.label = true;
  tmp482.units = ( ::impala::TUnit::type)7;
  tmp482.__isset.units = true;

  TMetricDefs.insert(std::make_pair("memory.num-maps", tmp482));
  TMetricDef tmp484;
  ...
  tmp484.description = "Resident set size (RSS) of this process, including TCMalloc, buffer pool and Jvm.";
  tmp484.__isset.description = true;
  tmp484.key = "memory.rss";
  tmp484.__isset.key = true;
  tmp484.kind = ( ::impala::TMetricKind::type)0;
  tmp484.__isset.kind = true;
  tmp484.label = "Resident set size.";
  tmp484.__isset.label = true;
  tmp484.units = ( ::impala::TUnit::type)3;
  tmp484.__isset.units = true;

  TMetricDefs.insert(std::make_pair("memory.rss", tmp484));
  TMetricDef tmp486;
  ...
  tmp486.description = "The system-wide 'defrag' setting for Transparent Huge Pages.";
  tmp486.__isset.description = true;
  tmp486.key = "memory.thp.defrag";
  tmp486.__isset.key = true;
  tmp486.kind = ( ::impala::TMetricKind::type)2;
  tmp486.__isset.kind = true;
  tmp486.label = "Transparent Huge Pages Defrag Enabled.";
  tmp486.__isset.label = true;
  tmp486.units = ( ::impala::TUnit::type)7;
  tmp486.__isset.units = true;

  TMetricDefs.insert(std::make_pair("memory.thp.defrag", tmp486));
  TMetricDef tmp488;
  ...
  tmp488.description = "The system-wide 'enabled' setting for Transparent Huge Pages.";
  tmp488.__isset.description = true;
  tmp488.key = "memory.thp.enabled";
  tmp488.__isset.key = true;
  tmp488.kind = ( ::impala::TMetricKind::type)2;
  tmp488.__isset.kind = true;
  tmp488.label = "Transparent Huge Pages Enabled.";
  tmp488.__isset.label = true;
  tmp488.units = ( ::impala::TUnit::type)7;
  tmp488.__isset.units = true;

  TMetricDefs.insert(std::make_pair("memory.thp.enabled", tmp488));
  TMetricDef tmp490;
  std::vector<std::string>  tmp491;
  tmp491.push_back("STATESTORE");
  tmp491.push_back("CATALOGSERVER");
  tmp491.push_back("IMPALAD");

  tmp490.contexts = tmp491;
  tmp490.__isset.contexts = true;
  tmp490.description = "The system-wide 'defrag' setting for khugepaged.";
  tmp490.__isset.description = true;
  tmp490.key = "memory.thp.khugepaged-defrag";
  tmp490.__isset.key = true;
  tmp490.kind = ( ::impala::TMetricKind::type)2;
  tmp490.__isset.kind = true;
  tmp490.label = "Khugepaged Defrag Enabled.";
  tmp490.__isset.label = true;
  tmp490.units = ( ::impala::TUnit::type)7;
  tmp490.__isset.units = true;

  TMetricDefs.insert(std::make_pair("memory.thp.khugepaged-defrag", tmp490));
  TMetricDef tmp492;
  ...
  tmp492.description = "Total memory currently used by TCMalloc and buffer pool.";
  tmp492.__isset.description = true;
  tmp492.key = "memory.total-used";
  tmp492.__isset.key = true;
  tmp492.kind = ( ::impala::TMetricKind::type)0;
  tmp492.__isset.kind = true;
  tmp492.label = "Total Used Memory.";
  tmp492.__isset.label = true;
  tmp492.units = ( ::impala::TUnit::type)3;
  tmp492.__isset.units = true;

  TMetricDefs.insert(std::make_pair("memory.total-used", tmp492));
  TMetricDef tmp494;
  std::vector<std::string>  tmp495;
  tmp495.push_back("IMPALAD");
  tmp495.push_back("CATALOGSERVER");
  tmp495.push_back("STATESTORE");

  tmp494.contexts = tmp495;
  tmp494.__isset.contexts = true;
  tmp494.description = "The local start time of the process";
  tmp494.__isset.description = true;
  tmp494.key = "process-start-time";
  tmp494.__isset.key = true;
  tmp494.kind = ( ::impala::TMetricKind::type)2;
  tmp494.__isset.kind = true;
  tmp494.label = "Process Start Time";
  tmp494.__isset.label = true;
  tmp494.units = ( ::impala::TUnit::type)7;
  tmp494.__isset.units = true;

  TMetricDefs.insert(std::make_pair("process-start-time", tmp494));
  TMetricDef tmp496;
  ...
  tmp496.description = "Time (ms) spent resolving request request pools.";
  tmp496.__isset.description = true;
  tmp496.key = "request-pool-service.resolve-pool-duration-ms";
  tmp496.__isset.key = true;
  tmp496.kind = ( ::impala::TMetricKind::type)3;
  tmp496.__isset.kind = true;
  tmp496.label = "Request Pool Service Resolve Pool Duration Ms";
  tmp496.__isset.label = true;
  tmp496.units = ( ::impala::TUnit::type)8;
  tmp496.__isset.units = true;

  TMetricDefs.insert(std::make_pair("request-pool-service.resolve-pool-duration-ms", tmp496));
  TMetricDef tmp498;
  std::vector<std::string>  tmp499;
  tmp499.push_back("CATALOGSERVER");
  tmp499.push_back("STATESTORE");
  tmp499.push_back("IMPALAD");

  tmp498.contexts = tmp499;
  tmp498.__isset.contexts = true;
  tmp498.description = "Duration (ms) of RPC calls to $0";
  tmp498.__isset.description = true;
  tmp498.key = "rpc-method.$0.call_duration";
  tmp498.__isset.key = true;
  tmp498.kind = ( ::impala::TMetricKind::type)5;
  tmp498.__isset.kind = true;
  tmp498.label = "$0 RPC Call Duration";
  tmp498.__isset.label = true;
  tmp498.units = ( ::impala::TUnit::type)8;
  tmp498.__isset.units = true;

  TMetricDefs.insert(std::make_pair("rpc-method.$0.call_duration", tmp498));
  TMetricDef tmp500;
  ...
  tmp500.description = "Service $0: Total number of incoming RPCs that were rejected due to overflow of the service queue.";
  tmp500.__isset.description = true;
  tmp500.key = "rpc.$0.rpcs_queue_overflow";
  tmp500.__isset.key = true;
  tmp500.kind = ( ::impala::TMetricKind::type)1;
  tmp500.__isset.kind = true;
  tmp500.label = "Service $0 Incoming RPC Queue Overflows";
  tmp500.__isset.label = true;
  tmp500.units = ( ::impala::TUnit::type)0;
  tmp500.__isset.units = true;

  TMetricDefs.insert(std::make_pair("rpc.$0.rpcs_queue_overflow", tmp500));
  TMetricDef tmp502;
  std::vector<std::string>  tmp503;
  tmp503.push_back("STATESTORE");
  tmp503.push_back("CATALOGSERVER");
  tmp503.push_back("IMPALAD");

  tmp502.contexts = tmp503;
  tmp502.__isset.contexts = true;
  tmp502.description = "Bytes allocated from the sanitizer malloc (Sanitizer debug builds only)";
  tmp502.__isset.description = true;
  tmp502.key = "sanitizer-total-bytes-allocated";
  tmp502.__isset.key = true;
  tmp502.kind = ( ::impala::TMetricKind::type)0;
  tmp502.__isset.kind = true;
  tmp502.label = "Sanitizer Malloc Bytes Allocated";
  tmp502.__isset.label = true;
  tmp502.units = ( ::impala::TUnit::type)3;
  tmp502.__isset.units = true;

  TMetricDefs.insert(std::make_pair("sanitizer-total-bytes-allocated", tmp502));
  TMetricDef tmp504;
  ...
  tmp504.description = "Number of senders waiting for receiving fragment to initialize";
  tmp504.__isset.description = true;
  tmp504.key = "senders-blocked-on-recvr-creation";
  tmp504.__isset.key = true;
  tmp504.kind = ( ::impala::TMetricKind::type)0;
  tmp504.__isset.kind = true;
  tmp504.label = "Number of senders waiting for receiving fragment to initialize.";
  tmp504.__isset.label = true;
  tmp504.units = ( ::impala::TUnit::type)7;
  tmp504.__isset.units = true;

  TMetricDefs.insert(std::make_pair("senders-blocked-on-recvr-creation", tmp504));
  TMetricDef tmp506;
  ...
  tmp506.description = "The number of assignments";
  tmp506.__isset.description = true;
  tmp506.key = "simple-scheduler.assignments.total";
  tmp506.__isset.key = true;
  tmp506.kind = ( ::impala::TMetricKind::type)1;
  tmp506.__isset.kind = true;
  tmp506.label = "Assignments";
  tmp506.__isset.label = true;
  tmp506.units = ( ::impala::TUnit::type)0;
  tmp506.__isset.units = true;

  TMetricDefs.insert(std::make_pair("simple-scheduler.assignments.total", tmp506));
  TMetricDef tmp508;
  ...
  tmp508.description = "Indicates whether the scheduler has been initialized.";
  tmp508.__isset.description = true;
  tmp508.key = "simple-scheduler.initialized";
  tmp508.__isset.key = true;
  tmp508.kind = ( ::impala::TMetricKind::type)2;
  tmp508.__isset.kind = true;
  tmp508.label = "Simple Scheduler Initialized";
  tmp508.__isset.label = true;
  tmp508.units = ( ::impala::TUnit::type)7;
  tmp508.__isset.units = true;

  TMetricDefs.insert(std::make_pair("simple-scheduler.initialized", tmp508));
  TMetricDef tmp510;
  ...
  tmp510.description = "Number of assignments operating on local data";
  tmp510.__isset.description = true;
  tmp510.key = "simple-scheduler.local-assignments.total";
  tmp510.__isset.key = true;
  tmp510.kind = ( ::impala::TMetricKind::type)1;
  tmp510.__isset.kind = true;
  tmp510.label = "Local Assignments";
  tmp510.__isset.label = true;
  tmp510.units = ( ::impala::TUnit::type)0;
  tmp510.__isset.units = true;

  TMetricDefs.insert(std::make_pair("simple-scheduler.local-assignments.total", tmp510));
  TMetricDef tmp512;
  ...
  tmp512.description = "The number of backend connections from this Impala Daemon to other Impala Daemons.";
  tmp512.__isset.description = true;
  tmp512.key = "simple-scheduler.num-backends";
  tmp512.__isset.key = true;
  tmp512.kind = ( ::impala::TMetricKind::type)0;
  tmp512.__isset.kind = true;
  tmp512.label = "Backend Connections";
  tmp512.__isset.label = true;
  tmp512.units = ( ::impala::TUnit::type)7;
  tmp512.__isset.units = true;

  TMetricDefs.insert(std::make_pair("simple-scheduler.num-backends", tmp512));
  TMetricDef tmp514;
  ...
  tmp514.description = "Whether the Impala Daemon considers itself connected to the StateStore.";
  tmp514.__isset.description = true;
  tmp514.key = "statestore-subscriber.connected";
  tmp514.__isset.key = true;
  tmp514.kind = ( ::impala::TMetricKind::type)2;
  tmp514.__isset.kind = true;
  tmp514.label = "StateStore Connectivity";
  tmp514.__isset.label = true;
  tmp514.units = ( ::impala::TUnit::type)7;
  tmp514.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.connected", tmp514));
  TMetricDef tmp516;
  ...
  tmp516.description = "The time (sec) between Statestore heartbeats.";
  tmp516.__isset.description = true;
  tmp516.key = "statestore-subscriber.heartbeat-interval-time";
  tmp516.__isset.key = true;
  tmp516.kind = ( ::impala::TMetricKind::type)3;
  tmp516.__isset.kind = true;
  tmp516.label = "Statestore Subscriber Heartbeat Interval Time";
  tmp516.__isset.label = true;
  tmp516.units = ( ::impala::TUnit::type)9;
  tmp516.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.heartbeat-interval-time", tmp516));
  TMetricDef tmp518;
  ...
  tmp518.description = "The amount of time the StateStore subscriber took to recover the connection the last time it was lost.";
  tmp518.__isset.description = true;
  tmp518.key = "statestore-subscriber.last-recovery-duration";
  tmp518.__isset.key = true;
  tmp518.kind = ( ::impala::TMetricKind::type)0;
  tmp518.__isset.kind = true;
  tmp518.label = "StateStore Subscriber Last Recovery Duration";
  tmp518.__isset.label = true;
  tmp518.units = ( ::impala::TUnit::type)9;
  tmp518.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.last-recovery-duration", tmp518));
  TMetricDef tmp520;
  ...
  tmp520.description = "The local time that the last statestore recovery happened.";
  tmp520.__isset.description = true;
  tmp520.key = "statestore-subscriber.last-recovery-time";
  tmp520.__isset.key = true;
  tmp520.kind = ( ::impala::TMetricKind::type)2;
  tmp520.__isset.kind = true;
  tmp520.label = "Statestore Subscriber Last Recovery Time";
  tmp520.__isset.label = true;
  tmp520.units = ( ::impala::TUnit::type)7;
  tmp520.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.last-recovery-time", tmp520));
  TMetricDef tmp522;
  ...
  tmp522.description = "Number of times that the Daemon detected a loss of connectivity to the StateStore.";
  tmp522.__isset.description = true;
  tmp522.key = "statestore-subscriber.num-connection-failures";
  tmp522.__isset.key = true;
  tmp522.kind = ( ::impala::TMetricKind::type)1;
  tmp522.__isset.kind = true;
  tmp522.label = "StateStore Connectivity Loss Count.";
  tmp522.__isset.label = true;
  tmp522.units = ( ::impala::TUnit::type)0;
  tmp522.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.num-connection-failures", tmp522));
  TMetricDef tmp524;
  ...
  tmp524.description = "The most recent registration ID for this subscriber with the statestore. Set to 'N/A' if no registration has been completed";
  tmp524.__isset.description = true;
  tmp524.key = "statestore-subscriber.registration-id";
  tmp524.__isset.key = true;
  tmp524.kind = ( ::impala::TMetricKind::type)2;
  tmp524.__isset.kind = true;
  tmp524.label = "Statestore Subscriber Registration Id";
  tmp524.__isset.label = true;
  tmp524.units = ( ::impala::TUnit::type)7;
  tmp524.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.registration-id", tmp524));
  TMetricDef tmp526;
  ...
  tmp526.description = "The number of active StateStore subscriber clients in this Impala Daemon's client cache. These clients are for communication from this role to the StateStore.";
  tmp526.__isset.description = true;
  tmp526.key = "statestore-subscriber.statestore.client-cache.clients-in-use";
  tmp526.__isset.key = true;
  tmp526.kind = ( ::impala::TMetricKind::type)0;
  tmp526.__isset.kind = true;
  tmp526.label = "StateStore Subscriber Active Clients";
  tmp526.__isset.label = true;
  tmp526.units = ( ::impala::TUnit::type)7;
  tmp526.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.statestore.client-cache.clients-in-use", tmp526));
  TMetricDef tmp528;
  ...
  tmp528.description = "The total number of StateStore subscriber clients in this Impala Daemon's client cache. These clients are for communication from this role to the StateStore.";
  tmp528.__isset.description = true;
  tmp528.key = "statestore-subscriber.statestore.client-cache.total-clients";
  tmp528.__isset.key = true;
  tmp528.kind = ( ::impala::TMetricKind::type)0;
  tmp528.__isset.kind = true;
  tmp528.label = "StateStore Subscriber Total Clients";
  tmp528.__isset.label = true;
  tmp528.units = ( ::impala::TUnit::type)7;
  tmp528.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.statestore.client-cache.total-clients", tmp528));
  TMetricDef tmp530;
  ...
  tmp530.description = "Statestore Subscriber Topic $0 Processing Time";
  tmp530.__isset.description = true;
  tmp530.key = "statestore-subscriber.topic-$0.processing-time-s";
  tmp530.__isset.key = true;
  tmp530.kind = ( ::impala::TMetricKind::type)3;
  tmp530.__isset.kind = true;
  tmp530.label = "Statestore Subscriber Topic $0 Processing Time";
  tmp530.__isset.label = true;
  tmp530.units = ( ::impala::TUnit::type)9;
  tmp530.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.topic-$0.processing-time-s", tmp530));
  TMetricDef tmp532;
  std::vector<std::string>  tmp533;
  tmp533.push_back("CATALOGSERVER");
  tmp533.push_back("IMPALAD");

  tmp532.contexts = tmp533;
  tmp532.__isset.contexts = true;
  tmp532.description = "Interval between topic updates for Topic $0";
  tmp532.__isset.description = true;
  tmp532.key = "statestore-subscriber.topic-$0.update-interval";
  tmp532.__isset.key = true;
  tmp532.kind = ( ::impala::TMetricKind::type)3;
  tmp532.__isset.kind = true;
  tmp532.label = "Statestore Subscriber Topic $0 Update Interval";
  tmp532.__isset.label = true;
  tmp532.units = ( ::impala::TUnit::type)9;
  tmp532.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.topic-$0.update-interval", tmp532));
  TMetricDef tmp534;
  std::vector<std::string>  tmp535;
  tmp535.push_back("CATALOGSERVER");
  tmp535.push_back("IMPALAD");

  tmp534.contexts = tmp535;
  tmp534.__isset.contexts = true;
  tmp534.description = "The time (sec) taken to process Statestore subscriber topic updates.";
  tmp534.__isset.description = true;
  tmp534.key = "statestore-subscriber.topic-update-duration";
  tmp534.__isset.key = true;
  tmp534.kind = ( ::impala::TMetricKind::type)3;
  tmp534.__isset.kind = true;
  tmp534.label = "Statestore Subscriber Topic Update Duration";
  tmp534.__isset.label = true;
  tmp534.units = ( ::impala::TUnit::type)9;
  tmp534.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.topic-update-duration", tmp534));
  TMetricDef tmp536;
  std::vector<std::string>  tmp537;
  tmp537.push_back("CATALOGSERVER");
  tmp537.push_back("IMPALAD");

  tmp536.contexts = tmp537;
  tmp536.__isset.contexts = true;
  tmp536.description = "The time (sec) between Statestore subscriber topic updates.";
  tmp536.__isset.description = true;
  tmp536.key = "statestore-subscriber.topic-update-interval-time";
  tmp536.__isset.key = true;
  tmp536.kind = ( ::impala::TMetricKind::type)3;
  tmp536.__isset.kind = true;
  tmp536.label = "Statestore Subscriber Topic Update Interval Time";
  tmp536.__isset.label = true;
  tmp536.units = ( ::impala::TUnit::type)9;
  tmp536.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore-subscriber.topic-update-interval-time", tmp536));
  TMetricDef tmp538;
  ...
  tmp538.description = "The time (sec) spent sending heartbeat RPCs. Includes subscriber-side processing time and network transmission time.";
  tmp538.__isset.description = true;
  tmp538.key = "statestore.heartbeat-durations";
  tmp538.__isset.key = true;
  tmp538.kind = ( ::impala::TMetricKind::type)3;
  tmp538.__isset.kind = true;
  tmp538.label = "Statestore Heartbeat Durations";
  tmp538.__isset.label = true;
  tmp538.units = ( ::impala::TUnit::type)9;
  tmp538.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.heartbeat-durations", tmp538));
  TMetricDef tmp540;
  ...
  tmp540.description = "The number of registered Statestore subscribers.";
  tmp540.__isset.description = true;
  tmp540.key = "statestore.live-backends";
  tmp540.__isset.key = true;
  tmp540.kind = ( ::impala::TMetricKind::type)0;
  tmp540.__isset.kind = true;
  tmp540.label = "Statestore Live Backends";
  tmp540.__isset.label = true;
  tmp540.units = ( ::impala::TUnit::type)7;
  tmp540.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.live-backends", tmp540));
  TMetricDef tmp542;
  ...
  tmp542.description = "The set of all live Statestore subscribers.";
  tmp542.__isset.description = true;
  tmp542.key = "statestore.live-backends.list";
  tmp542.__isset.key = true;
  tmp542.kind = ( ::impala::TMetricKind::type)4;
  tmp542.__isset.kind = true;
  tmp542.label = "Statestore Live Backends List";
  tmp542.__isset.label = true;
  tmp542.units = ( ::impala::TUnit::type)7;
  tmp542.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.live-backends.list", tmp542));
  TMetricDef tmp544;
  ...
  tmp544.description = "The time (sec) spent sending priority topic update RPCs. Includes subscriber-side processing time and network transmission time.";
  tmp544.__isset.description = true;
  tmp544.key = "statestore.priority-topic-update-durations";
  tmp544.__isset.key = true;
  tmp544.kind = ( ::impala::TMetricKind::type)3;
  tmp544.__isset.kind = true;
  tmp544.label = "Statestore Priority Topic Update Durations";
  tmp544.__isset.label = true;
  tmp544.units = ( ::impala::TUnit::type)9;
  tmp544.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.priority-topic-update-durations", tmp544));
  TMetricDef tmp546;
  ...
  tmp546.description = "The time (sec) spent sending non-priority topic update RPCs. Includes subscriber-side processing time and network transmission time.";
  tmp546.__isset.description = true;
  tmp546.key = "statestore.topic-update-durations";
  tmp546.__isset.key = true;
  tmp546.kind = ( ::impala::TMetricKind::type)3;
  tmp546.__isset.kind = true;
  tmp546.label = "Statestore Topic Update Durations";
  tmp546.__isset.label = true;
  tmp546.units = ( ::impala::TUnit::type)9;
  tmp546.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.topic-update-durations", tmp546));
  TMetricDef tmp548;
  ...
  tmp548.description = "The sum of the size of all keys for all topics tracked by the StateStore.";
  tmp548.__isset.description = true;
  tmp548.key = "statestore.total-key-size-bytes";
  tmp548.__isset.key = true;
  tmp548.kind = ( ::impala::TMetricKind::type)0;
  tmp548.__isset.kind = true;
  tmp548.label = "Topic Key Size";
  tmp548.__isset.label = true;
  tmp548.units = ( ::impala::TUnit::type)7;
  tmp548.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.total-key-size-bytes", tmp548));
  TMetricDef tmp550;
  ...
  tmp550.description = "The sum of the size of all keys and all values for all topics tracked by the StateStore.";
  tmp550.__isset.description = true;
  tmp550.key = "statestore.total-topic-size-bytes";
  tmp550.__isset.key = true;
  tmp550.kind = ( ::impala::TMetricKind::type)0;
  tmp550.__isset.kind = true;
  tmp550.label = "Topic Size";
  tmp550.__isset.label = true;
  tmp550.units = ( ::impala::TUnit::type)7;
  tmp550.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.total-topic-size-bytes", tmp550));
  TMetricDef tmp552;
  ...
  tmp552.description = "The sum of the size of all values for all topics tracked by the StateStore.";
  tmp552.__isset.description = true;
  tmp552.key = "statestore.total-value-size-bytes";
  tmp552.__isset.key = true;
  tmp552.kind = ( ::impala::TMetricKind::type)0;
  tmp552.__isset.kind = true;
  tmp552.label = "Topic Value Size";
  tmp552.__isset.label = true;
  tmp552.units = ( ::impala::TUnit::type)7;
  tmp552.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.total-value-size-bytes", tmp552));
  TMetricDef tmp554;
  ...
  tmp554.description = "The full version string of the Statestore Server.";
  tmp554.__isset.description = true;
  tmp554.key = "statestore.version";
  tmp554.__isset.key = true;
  tmp554.kind = ( ::impala::TMetricKind::type)2;
  tmp554.__isset.kind = true;
  tmp554.label = "Statestore Version";
  tmp554.__isset.label = true;
  tmp554.units = ( ::impala::TUnit::type)7;
  tmp554.__isset.units = true;

  TMetricDefs.insert(std::make_pair("statestore.version", tmp554));
  TMetricDef tmp556;
  ...
  tmp556.description = "The number of clients in use by the Statestore heartbeat client cache.";
  tmp556.__isset.description = true;
  tmp556.key = "subscriber-heartbeat.client-cache.clients-in-use";
  tmp556.__isset.key = true;
  tmp556.kind = ( ::impala::TMetricKind::type)0;
  tmp556.__isset.kind = true;
  tmp556.label = "Subscriber Heartbeat Client Cache Clients In Use";
  tmp556.__isset.label = true;
  tmp556.units = ( ::impala::TUnit::type)7;
  tmp556.__isset.units = true;

  TMetricDefs.insert(std::make_pair("subscriber-heartbeat.client-cache.clients-in-use", tmp556));
  TMetricDef tmp558;
  ...
  tmp558.description = "The total number of clients in the Statestore heartbeat client cache.";
  tmp558.__isset.description = true;
  tmp558.key = "subscriber-heartbeat.client-cache.total-clients";
  tmp558.__isset.key = true;
  tmp558.kind = ( ::impala::TMetricKind::type)0;
  tmp558.__isset.kind = true;
  tmp558.label = "Subscriber Heartbeat Client Cache Total Clients";
  tmp558.__isset.label = true;
  tmp558.units = ( ::impala::TUnit::type)7;
  tmp558.__isset.units = true;

  TMetricDefs.insert(std::make_pair("subscriber-heartbeat.client-cache.total-clients", tmp558));
  TMetricDef tmp560;
  ...
  tmp560.description = "The number of clients in use by the Statestore update state client cache.";
  tmp560.__isset.description = true;
  tmp560.key = "subscriber-update-state.client-cache.clients-in-use";
  tmp560.__isset.key = true;
  tmp560.kind = ( ::impala::TMetricKind::type)0;
  tmp560.__isset.kind = true;
  tmp560.label = "Subscriber Update State Client Cache Clients In Use";
  tmp560.__isset.label = true;
  tmp560.units = ( ::impala::TUnit::type)7;
  tmp560.__isset.units = true;

  TMetricDefs.insert(std::make_pair("subscriber-update-state.client-cache.clients-in-use", tmp560));
  TMetricDef tmp562;
  ...
  tmp562.description = "The total number of clients in the Statestore update state client cache.";
  tmp562.__isset.description = true;
  tmp562.key = "subscriber-update-state.client-cache.total-clients";
  tmp562.__isset.key = true;
  tmp562.kind = ( ::impala::TMetricKind::type)0;
  tmp562.__isset.kind = true;
  tmp562.label = "Subscriber Update State Client Cache Total Clients";
  tmp562.__isset.label = true;
  tmp562.units = ( ::impala::TUnit::type)7;
  tmp562.__isset.units = true;

  TMetricDefs.insert(std::make_pair("subscriber-update-state.client-cache.total-clients", tmp562));
  TMetricDef tmp564;
  ...
  tmp564.description = "Number of bytes used by the application. This will not typically match the memory use reported by the OS, because it does not include TCMalloc overhead or memory fragmentation.";
  tmp564.__isset.description = true;
  tmp564.key = "tcmalloc.bytes-in-use";
  tmp564.__isset.key = true;
  tmp564.kind = ( ::impala::TMetricKind::type)0;
  tmp564.__isset.kind = true;
  tmp564.label = "TCMalloc Bytes in Use";
  tmp564.__isset.label = true;
  tmp564.units = ( ::impala::TUnit::type)3;
  tmp564.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tcmalloc.bytes-in-use", tmp564));
  TMetricDef tmp566;
  ...
  tmp566.description = "Number of bytes in free, mapped pages in page heap. These bytes can be used to fulfill allocation requests. They always count towards virtual memory usage, and unless the underlying memory is swapped out by the OS, they also count towards physical memory usage.";
  tmp566.__isset.description = true;
  tmp566.key = "tcmalloc.pageheap-free-bytes";
  tmp566.__isset.key = true;
  tmp566.kind = ( ::impala::TMetricKind::type)0;
  tmp566.__isset.kind = true;
  tmp566.label = "TCMalloc Pageheap Free";
  tmp566.__isset.label = true;
  tmp566.units = ( ::impala::TUnit::type)3;
  tmp566.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tcmalloc.pageheap-free-bytes", tmp566));
  TMetricDef tmp568;
  ...
  tmp568.description = "Number of bytes in free, unmapped pages in page heap. These are bytes that have been released back to the OS, possibly by one of the MallocExtension \"Release\" calls. They can be used to fulfill allocation requests, but typically incur a page fault. They always count towards virtual memory usage, and depending on the OS, typically do not count towards physical memory usage.";
  tmp568.__isset.description = true;
  tmp568.key = "tcmalloc.pageheap-unmapped-bytes";
  tmp568.__isset.key = true;
  tmp568.kind = ( ::impala::TMetricKind::type)0;
  tmp568.__isset.kind = true;
  tmp568.label = "TCMalloc Pageheap Unmapped";
  tmp568.__isset.label = true;
  tmp568.units = ( ::impala::TUnit::type)3;
  tmp568.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tcmalloc.pageheap-unmapped-bytes", tmp568));
  TMetricDef tmp570;
  ...
  tmp570.description = "Derived metric computing the amount of physical memory (in bytes) used by the process, including that actually in use and free bytes reserved by tcmalloc. Does not include the tcmalloc metadata.";
  tmp570.__isset.description = true;
  tmp570.key = "tcmalloc.physical-bytes-reserved";
  tmp570.__isset.key = true;
  tmp570.kind = ( ::impala::TMetricKind::type)0;
  tmp570.__isset.kind = true;
  tmp570.label = "TCMalloc Physical Bytes Reserved";
  tmp570.__isset.label = true;
  tmp570.units = ( ::impala::TUnit::type)3;
  tmp570.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tcmalloc.physical-bytes-reserved", tmp570));
  TMetricDef tmp572;
  std::vector<std::string>  tmp573;
  tmp573.push_back("STATESTORE");
  tmp573.push_back("CATALOGSERVER");
  tmp573.push_back("IMPALAD");

  tmp572.contexts = tmp573;
  tmp572.__isset.contexts = true;
  tmp572.description = "Bytes of system memory reserved by TCMalloc.";
  tmp572.__isset.description = true;
  tmp572.key = "tcmalloc.total-bytes-reserved";
  tmp572.__isset.key = true;
  tmp572.kind = ( ::impala::TMetricKind::type)0;
  tmp572.__isset.kind = true;
  tmp572.label = "TCMalloc Total Bytes Reserved";
  tmp572.__isset.label = true;
  tmp572.units = ( ::impala::TUnit::type)3;
  tmp572.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tcmalloc.total-bytes-reserved", tmp572));
  TMetricDef tmp574;
  std::vector<std::string>  tmp575;
  tmp575.push_back("STATESTORE");
  tmp575.push_back("CATALOGSERVER");
  tmp575.push_back("IMPALAD");

  tmp574.contexts = tmp575;
  tmp574.__isset.contexts = true;
  tmp574.description = "The number of running threads in this process.";
  tmp574.__isset.description = true;
  tmp574.key = "thread-manager.running-threads";
  tmp574.__isset.key = true;
  tmp574.kind = ( ::impala::TMetricKind::type)0;
  tmp574.__isset.kind = true;
  tmp574.label = "Running Threads";
  tmp574.__isset.label = true;
  tmp574.units = ( ::impala::TUnit::type)7;
  tmp574.__isset.units = true;

  TMetricDefs.insert(std::make_pair("thread-manager.running-threads", tmp574));
  TMetricDef tmp576;
  std::vector<std::string>  tmp577;
  tmp577.push_back("STATESTORE");
  tmp577.push_back("CATALOGSERVER");
  tmp577.push_back("IMPALAD");

  tmp576.contexts = tmp577;
  tmp576.__isset.contexts = true;
  tmp576.description = "Threads created over the lifetime of the process.";
  tmp576.__isset.description = true;
  tmp576.key = "thread-manager.total-threads-created";
  tmp576.__isset.key = true;
  tmp576.kind = ( ::impala::TMetricKind::type)0;
  tmp576.__isset.kind = true;
  tmp576.label = "Threads Created";
  tmp576.__isset.label = true;
  tmp576.units = ( ::impala::TUnit::type)7;
  tmp576.__isset.units = true;

  TMetricDefs.insert(std::make_pair("thread-manager.total-threads-created", tmp576));
  TMetricDef tmp578;
  ...
  tmp578.description = "The number of active scratch directories for spilling to disk.";
  tmp578.__isset.description = true;
  tmp578.key = "tmp-file-mgr.active-scratch-dirs";
  tmp578.__isset.key = true;
  tmp578.kind = ( ::impala::TMetricKind::type)0;
  tmp578.__isset.kind = true;
  tmp578.label = "Active scratch directories";
  tmp578.__isset.label = true;
  tmp578.units = ( ::impala::TUnit::type)7;
  tmp578.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tmp-file-mgr.active-scratch-dirs", tmp578));
  TMetricDef tmp580;
  ...
  tmp580.description = "The set of all active scratch directories for spilling to disk.";
  tmp580.__isset.description = true;
  tmp580.key = "tmp-file-mgr.active-scratch-dirs.list";
  tmp580.__isset.key = true;
  tmp580.kind = ( ::impala::TMetricKind::type)4;
  tmp580.__isset.kind = true;
  tmp580.label = "Active scratch directories list";
  tmp580.__isset.label = true;
  tmp580.units = ( ::impala::TUnit::type)7;
  tmp580.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tmp-file-mgr.active-scratch-dirs.list", tmp580));
  TMetricDef tmp582;
  ...
  tmp582.description = "The current total spilled bytes for the local buffer directory.";
  tmp582.__isset.description = true;
  tmp582.key = "tmp-file-mgr.local-buff-bytes-used.dir-$0";
  tmp582.__isset.key = true;
  tmp582.kind = ( ::impala::TMetricKind::type)0;
  tmp582.__isset.kind = true;
  tmp582.label = "Per-directory local buffer space bytes used";
  tmp582.__isset.label = true;
  tmp582.units = ( ::impala::TUnit::type)3;
  tmp582.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tmp-file-mgr.local-buff-bytes-used.dir-$0", tmp582));
  TMetricDef tmp584;
  ...
  tmp584.description = "The current total spilled bytes across all scratch directories.";
  tmp584.__isset.description = true;
  tmp584.key = "tmp-file-mgr.scratch-space-bytes-used";
  tmp584.__isset.key = true;
  tmp584.kind = ( ::impala::TMetricKind::type)0;
  tmp584.__isset.kind = true;
  tmp584.label = "Spilled bytes for scratch directories";
  tmp584.__isset.label = true;
  tmp584.units = ( ::impala::TUnit::type)3;
  tmp584.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tmp-file-mgr.scratch-space-bytes-used", tmp584));
  TMetricDef tmp586;
  ...
  tmp586.description = "The high water mark for spilled bytes across all scratch directories.";
  tmp586.__isset.description = true;
  tmp586.key = "tmp-file-mgr.scratch-space-bytes-used-high-water-mark";
  tmp586.__isset.key = true;
  tmp586.kind = ( ::impala::TMetricKind::type)0;
  tmp586.__isset.kind = true;
  tmp586.label = "Spilled bytes HWM for scratch directories";
  tmp586.__isset.label = true;
  tmp586.units = ( ::impala::TUnit::type)3;
  tmp586.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tmp-file-mgr.scratch-space-bytes-used-high-water-mark", tmp586));
  TMetricDef tmp588;
  ...
  tmp588.description = "The current total spilled bytes for a single scratch directory.";
  tmp588.__isset.description = true;
  tmp588.key = "tmp-file-mgr.scratch-space-bytes-used.dir-$0";
  tmp588.__isset.key = true;
  tmp588.kind = ( ::impala::TMetricKind::type)0;
  tmp588.__isset.kind = true;
  tmp588.label = "Per-directory scratch space bytes used";
  tmp588.__isset.label = true;
  tmp588.units = ( ::impala::TUnit::type)3;
  tmp588.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tmp-file-mgr.scratch-space-bytes-used.dir-$0", tmp588));
  TMetricDef tmp590;
  ...
  tmp590.description = "The durations of dequeuing from the TmpFileBufferPool.";
  tmp590.__isset.description = true;
  tmp590.key = "tmp-file-mgr.tmp-file-buff-pool-dequeue-durations";
  tmp590.__isset.key = true;
  tmp590.kind = ( ::impala::TMetricKind::type)5;
  tmp590.__isset.kind = true;
  tmp590.label = "Dequeue durations for the TmpFileBufferPool";
  tmp590.__isset.label = true;
  tmp590.units = ( ::impala::TUnit::type)5;
  tmp590.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tmp-file-mgr.tmp-file-buff-pool-dequeue-durations", tmp590));
  TMetricDef tmp592;
  std::vector<std::string>  tmp593;
  tmp593.push_back("IMPALAD");

  tmp592.contexts = tmp593;
  tmp592.__isset.contexts = true;
  tmp592.description = "Total number of senders that have been blocked waiting for receiving fragment to initialize.";
  tmp592.__isset.description = true;
  tmp592.key = "total-senders-blocked-on-recvr-creation";
  tmp592.__isset.key = true;
  tmp592.kind = ( ::impala::TMetricKind::type)1;
  tmp592.__isset.kind = true;
  tmp592.label = "Total senders waiting for receiving fragment to initialize";
  tmp592.__isset.label = true;
  tmp592.units = ( ::impala::TUnit::type)7;
  tmp592.__isset.units = true;

  TMetricDefs.insert(std::make_pair("total-senders-blocked-on-recvr-creation", tmp592));
  TMetricDef tmp594;
  std::vector<std::string>  tmp595;
  tmp595.push_back("IMPALAD");

  tmp594.contexts = tmp595;
  tmp594.__isset.contexts = true;
  tmp594.description = "Total number of senders that timed-out waiting for receiving fragment to initialize.";
  tmp594.__isset.description = true;
  tmp594.key = "total-senders-timedout-waiting-for-recvr-creation";
  tmp594.__isset.key = true;
  tmp594.kind = ( ::impala::TMetricKind::type)1;
  tmp594.__isset.kind = true;
  tmp594.label = "Total senders timed-out waiting for receiving fragment to initialize";
  tmp594.__isset.label = true;
  tmp594.units = ( ::impala::TUnit::type)7;
  tmp594.__isset.units = true;

  TMetricDefs.insert(std::make_pair("total-senders-timedout-waiting-for-recvr-creation", tmp594));
  TMetricDef tmp596;
  std::vector<std::string>  tmp597;
  tmp597.push_back("IMPALAD");

  tmp596.contexts = tmp597;
  tmp596.__isset.contexts = true;
  tmp596.description = "Path to the time-zone database";
  tmp596.__isset.description = true;
  tmp596.key = "tzdata-path";
  tmp596.__isset.key = true;
  tmp596.kind = ( ::impala::TMetricKind::type)2;
  tmp596.__isset.kind = true;
  tmp596.label = "Path to the time-zone database";
  tmp596.__isset.label = true;
  tmp596.units = ( ::impala::TUnit::type)7;
  tmp596.__isset.units = true;

  TMetricDefs.insert(std::make_pair("tzdata-path", tmp596));
