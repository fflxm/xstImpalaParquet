...
//modify by ff #include "kudu/util/logging.h"
...
RuntimeProfile::ChunkedTimeSeriesCounter::ChunkedTimeSeriesCounter(
 ...
 //modify by bb , max_size_(10 * FLAGS_status_report_interval_ms / period_) {}
, max_size_(10 * 1105 / period_) {}
...
//modify by ff    KLOG_EVERY_N_SECS(WARNING, 60) << "ChunkedTimeSeriesCounter reached maximum size";
