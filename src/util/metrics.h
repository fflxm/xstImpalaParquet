...
//modify by ff #include <gtest/gtest_prod.h> // for FRIEND_TEST
...
//modify by ff #include "kudu/util/web_callback_registry.h"
#include "util/debug-util.h"
#include "util/metrics-fwd.h"
#include "util/spinlock.h"

//modify by ff using kudu::HttpStatusCode;
...
class AtomicHighWaterMarkGauge : public ScalarMetric<int64_t, TMetricKind::GAUGE> {
 ...
 private:
//modify by ff  FRIEND_TEST(MetricsTest, AtomicHighWaterMarkGauge);
...
class MetricGroup {
 public:
  ...
  //modify by ff Status RegisterHttpHandlers(Webserver* webserver);
 ...
 private:
//modify by ff  FRIEND_TEST(MetricsTest, PrometheusMetricNames);
