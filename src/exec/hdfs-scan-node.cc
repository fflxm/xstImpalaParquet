...
/*modify by ff  thread_state_.Prepare(this, EstimateScannerThreadMemConsumption());
...
//modify by ff    filter_status = filter.CloneFrom(filter_ctx, pool_, runtime_state_, &filter_mem_pool,
//        &expr_results_pool);
...
//modify by ff  thread_state_.Shutdown();
}
