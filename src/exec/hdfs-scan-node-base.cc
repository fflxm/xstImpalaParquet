...
//modify by ff #include "exec/base-sequence-scanner.h"
//modify by ff #include "exec/hdfs-avro-scanner.h"
#include "exec/hdfs-columnar-scanner.h"
//modify by ff #include "exec/hdfs-orc-scanner.h"
//modify by ff #include "exec/hdfs-plugin-text-scanner.h"
//modify by ff #include "exec/hdfs-rcfile-scanner.h"
//modify by ff #include "exec/hdfs-scan-node-mt.h"
#include "exec/hdfs-scan-node.h"
//modify by ff #include "exec/hdfs-sequence-scanner.h"
//modify by ff #include "exec/hdfs-text-scanner.h"
#include "exec/parquet/hdfs-parquet-scanner.h"

//modify by ff #include <avro/errors.h>
//modify by ff #include <avro/schema.h>
...
//modify by ff  state->CheckAndAddCodegenDisabledMessage(codegen_status_msgs_);
  return Status::OK();
}
...
//modify by ff    avro_schema_(*pnode.avro_schema_.get()),
...
/*modify by ff  for (const THdfsFileFormat::type format : tnode_->hdfs_scan_node.file_formats) {
    llvm::Function* fn;
    Status status;
    switch (format) {
  ...
  for (auto& entry : matching_per_type_files) {
    ...
    switch (entry.first) {
      case THdfsFileFormat::PARQUET:
        ...
        break;
/*modify by ff      case THdfsFileFormat::TEXT:
...
/*modify by ff    case THdfsFileFormat::TEXT:
    ...
    case THdfsFileFormat::PARQUET:
      ...
      break;
/*modify by ff    case THdfsFileFormat::ORC:
