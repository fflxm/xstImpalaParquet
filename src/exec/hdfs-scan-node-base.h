...
//modify by ff #include "util/avro-util.h"
...
//modify by ff  ScopedAvroSchemaElement avro_schema_;
...
//modify by ff  const AvroSchemaElement& avro_schema() const { return avro_schema_; }
...
//modify by ff
 ...
 protected:
  ...
  /// The root of the table's Avro schema, if we're scanning an Avro table.
//modify by ff  const AvroSchemaElement& avro_schema_;
