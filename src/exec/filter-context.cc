...
//modify by ff  return filter->Eval(val, expr_eval->root().type());
return true;
}
...
// }
/*modify by ff Status FilterContext::CodegenEval(
...
//   ret void
// }
/*modify by ff Status FilterContext::CodegenInsert(LlvmCodeGen* codegen, ScalarExpr* filter_expr,
