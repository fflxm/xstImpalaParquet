...
//modiby by ff :add "bool blocal"
  ...
  static Status IssueInitialRangesLocal(HdfsScanNodeBase* scan_node,
                                   const std::vector<HdfsFileDesc*>& files,bool blocal=true)
                                   WARN_UNUSED_RESULT;
...
//modify by ff  Status CreateColIdx2EqConjunctMap();
