...
Status Sorter::TupleSorter::Sort(Run* run) {
  ...
  run_ = run;
/*modify by ff  const SortHelperFn sort_helper_fn = parent_->codegend_sort_helper_fn_.load();
...
//modify by ff    const CodegenFnPtr<SortHelperFn>& codegend_sort_helper_fn,
...
//modify by ff    codegend_sort_helper_fn_(codegend_sort_helper_fn),
