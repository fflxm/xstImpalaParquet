...
//modify by ff #include <kudu/client/client.h>

//modify by ff
#include "query-exec-mgr.h"

// NOTE: try not to add more headers here: exec-env.h is included in many many files.
#include "common/global-types.h"
#include "common/status.h"
#include "runtime/client-cache-types.h"
//modify by ff #include "testutil/gtest-util.h"
...
//modify by ff class AdmissionController;
class BufferPool;
class CallableThreadPool;
 //modify by ff class ClusterMembershipMgr;
//modify by ff class ControlService;
class DataStreamMgr;
//modify by ff class DataStreamService;
//modify by ff class QueryExecMgr;
//modify by ff class Frontend;
//modify by ff class HBaseTableFactory;
class HdfsFsCache;
class ImpalaServer;
...
//modify by ff class RequestPoolService;
class ReservationTracker;
//modify by ff class RpcMgr;
//modify by ff class Scheduler;
class StatestoreSubscriber;
//modify by ff class SystemStateInfo;
class ThreadResourceMgr;
//modify by ff class TmpFileMgr;
//modify by ff class Webserver;
...
//modify by ff  KrpcDataStreamMgr* stream_mgr() { return stream_mgr_.get(); }
/*modify by ff
  CatalogServiceClientCache* catalogd_client_cache() {
    return catalogd_client_cache_.get();
  }*/
//modify by ff  HBaseTableFactory* htable_factory() { return htable_factory_.get(); }
  io::DiskIoMgr* disk_io_mgr() { return disk_io_mgr_.get(); }
//modify by ff  Webserver* webserver() { return webserver_.get(); }
//modify by ff  Webserver* metrics_webserver() { return metrics_webserver_.get(); }
...
//modify by ff  TmpFileMgr* tmp_file_mgr() { return tmp_file_mgr_.get(); }
  ImpalaServer* impala_server() { return impala_server_; }
  /*mofify by ff Frontend* frontend() {
    DCHECK(frontend_.get() != nullptr);
    return frontend_.get();
  }*/
//modify by ff  RequestPoolService* request_pool_service() { return request_pool_service_.get(); }
  CallableThreadPool* rpc_pool() { return async_rpc_pool_.get(); }
  QueryExecMgr* query_exec_mgr() { return query_exec_mgr_.get(); }
//modify by ff   RpcMgr* rpc_mgr() const { return rpc_mgr_.get(); }
...
//modify by ff  SystemStateInfo* system_state_info() { return system_state_info_.get(); }

  bool get_enable_webserver() const { return enable_webserver_; }

//modify by ff ClusterMembershipMgr* cluster_membership_mgr() { return cluster_membership_mgr_.get(); }
//modify by ff   Scheduler* scheduler() { return scheduler_.get(); }
//modify by ff  AdmissionController* admission_controller() { return admission_controller_.get(); }
//modify by ff  StatestoreSubscriber* subscriber() { return statestore_subscriber_.get(); }
  ...
  /// Thread safe.
//modify by ff  Status GetKuduClient(const std::vector<std::string>& master_addrs,
...
//modify by ff  boost::scoped_ptr<KrpcDataStreamMgr> stream_mgr_;
   //modify by ff boost::scoped_ptr<ClusterMembershipMgr> cluster_membership_mgr_;
//modify by ff  boost::scoped_ptr<Scheduler> scheduler_;
//modify by ff  boost::scoped_ptr<AdmissionController> admission_controller_;
//modify by ff  boost::scoped_ptr<StatestoreSubscriber> statestore_subscriber_;
//modify by ff  boost::scoped_ptr<CatalogServiceClientCache> catalogd_client_cache_;
  //modify by ff boost::scoped_ptr<HBaseTableFactory> htable_factory_;
  boost::scoped_ptr<io::DiskIoMgr> disk_io_mgr_;
  //modify by ff boost::scoped_ptr<Webserver> webserver_;
  //modify by ff boost::scoped_ptr<Webserver> metrics_webserver_;
...
//modify by ff  boost::scoped_ptr<TmpFileMgr> tmp_file_mgr_;
//modify by ff  boost::scoped_ptr<RequestPoolService> request_pool_service_;
  //modify by ff boost::scoped_ptr<Frontend> frontend_;

  boost::scoped_ptr<CallableThreadPool> async_rpc_pool_;
  boost::scoped_ptr<QueryExecMgr> query_exec_mgr_;
  //modify by ff boost::scoped_ptr<RpcMgr> rpc_mgr_;
  //modify by ff boost::scoped_ptr<ControlService> control_svc_;
  //modify by ff boost::scoped_ptr<DataStreamService> data_svc_;
...
//modify by ff  boost::scoped_ptr<SystemStateInfo> system_state_info_;
...
//modify by ff  FRIEND_TEST(HdfsUtilTest, CheckFilesystemsMatch);
 ...
 //modify by ff typedef std::unordered_map<std::string,
...
//modify by ff  KuduClientMap kudu_client_map_;
