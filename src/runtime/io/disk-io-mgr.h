...
//modify by ff #include "runtime/io/handle-cache.h"
//modify by ff #include "runtime/io/hdfs-monitored-ops.h"
...
//  Status Init() WARN_UNUSED_RESULT;
  Status Init(int threadnum=0) WARN_UNUSED_RESULT;
...
//modify by ff  DataCache* remote_data_cache() { return remote_data_cache_.get(); }
...
//modify by ff  HdfsMonitor hdfs_monitor_;
  ...
  // handles are closed.
//modify by ff  FileHandleCache file_handle_cache_;
...
//modify by ff  std::unique_ptr<DataCache> remote_data_cache_;
};
}
}
