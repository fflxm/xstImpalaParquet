...
//modify by ff class ControlServiceProxy;
...
//modify by ff
  ...
  /// Blocks until all fragment instances have finished their Prepare phase.
//modify by ff  void PublishFilter(const PublishFilterParamsPB& params, kudu::rpc::RpcContext* context);
 ...
 private:
  ...
  /// Set in Init().
//modify by ff  std::unique_ptr<ControlServiceProxy> proxy_;
