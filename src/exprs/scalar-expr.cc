...
//modify by ff #include "exprs/valid-tuple-id.h"
...
//modify by ff #include "gen-cpp/ImpalaService_types.h"
...
/*modify by ff    case TExprNodeType::BOOL_LITERAL:
...
//modify by ff      *expr = pool->Add(new ValidTupleIdExpr(texpr_node));
      return Status::OK();
    default:
      *expr = nullptr;
      stringstream os;
