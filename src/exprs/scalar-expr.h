...
//modify by ff #include "codegen/codegen-fn-ptr.h"
...
//modify by ff class LlvmCodeGen;
class MemTracker;
class ObjectPool;
class RowDescriptor;
class RuntimeState;
...
/*modify by ff  Status GetCodegendComputeFn(LlvmCodeGen* codegen, bool is_codegen_entry_point,
      llvm::Function** fn);
*/
 ...
 protected:
  ...
  /// ScalarExpr.
/*modify by ff  virtual Status GetCodegendComputeFnImpl(
...
*/
  ...
  /// tree.
/*modify by ff  llvm::Function* CreateIrFunctionPrototype(const std::string& name, LlvmCodeGen* codegen,
      llvm::Value* (*args)[2]);*/
 protected:
...
//modify by ff  llvm::Function* ir_compute_fn_ = nullptr;
...
//modify by ff   CodegenFnPtr<void*> codegend_compute_fn_;
