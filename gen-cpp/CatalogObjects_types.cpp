...
const std::map<int, const char*> _TIcebergPartitionTransformType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(7, _kTIcebergPartitionTransformTypeValues, _kTIcebergPartitionTransformTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
