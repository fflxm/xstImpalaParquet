...
struct TEnabledRuntimeFilterTypes {
  enum type {
    BLOOM = 1,
    MIN_MAX = 2,
    ALL = 3
...
extern const std::map<int, const char*> _TEnabledRuntimeFilterTypes_VALUES_TO_NAMES;
...
typedef struct _TScanRange__isset {
  _TScanRange__isset() : hdfs_file_split(false), hbase_key_range(false), kudu_scan_token(false) {}
