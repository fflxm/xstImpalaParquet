    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->repetition_type = (FieldRepetitionType::type)ecast77;
      ...
      case 6:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->converted_type = (ConvertedType::type)ecast78;
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = (Encoding::type)ecast83;
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->definition_level_encoding = (Encoding::type)ecast84;
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->repetition_level_encoding = (Encoding::type)ecast85;
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = (Encoding::type)ecast94;
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = (Encoding::type)ecast99;
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (PageType::type)ecast132;
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->page_type = (PageType::type)ecast145;
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->encoding = (Encoding::type)ecast146;
          isset_encoding = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            for (_i156 = 0; _i156 < _size152; ++_i156)
            {
              ...
              this->encodings[_i156] = (Encoding::type)ecast157;
            }
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->codec = (CompressionCodec::type)ecast163;
          isset_codec = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->boundary_order = (BoundaryOrder::type)ecast257;
